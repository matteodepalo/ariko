...
impl W {
  #[doc = "Bits 0:2 - Phase 2 segment"]
  #[inline(always)]
  pub fn phase2(&mut self) -> Phase2W<'_, BrSpec> {
    Phase2W::new(self, 0)
  }
  #[doc = "Bits 4:6 - Phase 1 segment"]
  #[inline(always)]
  pub fn phase1(&mut self) -> Phase1W<'_, BrSpec> {
    Phase1W::new(self, 4)
  }
  #[doc = "Bits 8:10 - Programming time segment"]
  #[inline(always)]
  pub fn propag(&mut self) -> PropagW<'_, BrSpec> {
    PropagW::new(self, 8)
  }
  #[doc = "Bits 12:13 - Re-synchronization jump width"]
  #[inline(always)]
  pub fn sjw(&mut self) -> SjwW<'_, BrSpec> {
    SjwW::new(self, 12)
  }
  #[doc = "Bits 16:22 - Baudrate Prescaler."]
  #[inline(always)]
  pub fn brp(&mut self) -> BrpW<'_, BrSpec> {
    BrpW::new(self, 16)
  }
  #[doc = "Bit 24 - Sampling Mode"]
  #[inline(always)]
  pub fn smp(&mut self) -> SmpW<'_, BrSpec> {
    SmpW::new(self, 24)
  }
}
