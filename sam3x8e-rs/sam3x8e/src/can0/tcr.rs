...
impl W {
  ...
  #[inline(always)]
  pub fn mb0(&mut self) -> Mb0W<'_, TcrSpec> {
    Mb0W::new(self, 0)
  }
  #[doc = "Bit 1 - Transfer Request for Mailbox 1"]
  #[inline(always)]
  pub fn mb1(&mut self) -> Mb1W<'_, TcrSpec> {
    Mb1W::new(self, 1)
  }
  #[doc = "Bit 2 - Transfer Request for Mailbox 2"]
  #[inline(always)]
  pub fn mb2(&mut self) -> Mb2W<'_, TcrSpec> {
    Mb2W::new(self, 2)
  }
  #[doc = "Bit 3 - Transfer Request for Mailbox 3"]
  #[inline(always)]
  pub fn mb3(&mut self) -> Mb3W<'_, TcrSpec> {
    Mb3W::new(self, 3)
  }
  #[doc = "Bit 4 - Transfer Request for Mailbox 4"]
  #[inline(always)]
  pub fn mb4(&mut self) -> Mb4W<'_, TcrSpec> {
    Mb4W::new(self, 4)
  }
  #[doc = "Bit 5 - Transfer Request for Mailbox 5"]
  #[inline(always)]
  pub fn mb5(&mut self) -> Mb5W<'_, TcrSpec> {
    Mb5W::new(self, 5)
  }
  #[doc = "Bit 6 - Transfer Request for Mailbox 6"]
  #[inline(always)]
  pub fn mb6(&mut self) -> Mb6W<'_, TcrSpec> {
    Mb6W::new(self, 6)
  }
  #[doc = "Bit 7 - Transfer Request for Mailbox 7"]
  #[inline(always)]
  pub fn mb7(&mut self) -> Mb7W<'_, TcrSpec> {
    Mb7W::new(self, 7)
  }
  #[doc = "Bit 31 - Timer Reset"]
  #[inline(always)]
  pub fn timrst(&mut self) -> TimrstW<'_, TcrSpec> {
    TimrstW::new(self, 31)
  }
}
