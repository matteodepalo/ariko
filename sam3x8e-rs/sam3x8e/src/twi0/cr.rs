...
impl W {
  ...
  #[inline(always)]
  pub fn msen(&mut self) -> MsenW<'_, CrSpec> {
    MsenW::new(self, 2)
  }
  #[doc = "Bit 3 - TWI Master Mode Disabled"]
  #[inline(always)]
  pub fn msdis(&mut self) -> MsdisW<'_, CrSpec> {
    MsdisW::new(self, 3)
  }
  #[doc = "Bit 4 - TWI Slave Mode Enabled"]
  #[inline(always)]
  pub fn sven(&mut self) -> SvenW<'_, CrSpec> {
    SvenW::new(self, 4)
  }
  #[doc = "Bit 5 - TWI Slave Mode Disabled"]
  #[inline(always)]
  pub fn svdis(&mut self) -> SvdisW<'_, CrSpec> {
    SvdisW::new(self, 5)
  }
  #[doc = "Bit 6 - SMBUS Quick Command"]
  #[inline(always)]
  pub fn quick(&mut self) -> QuickW<'_, CrSpec> {
    QuickW::new(self, 6)
  }
