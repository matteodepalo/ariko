...
impl W {
  ...
  #[inline(always)]
  pub fn p0(&mut self) -> P0W<'_, OwdrSpec> {
    P0W::new(self, 0)
  }
  #[doc = "Bit 1 - Output Write Disable."]
  #[inline(always)]
  pub fn p1(&mut self) -> P1W<'_, OwdrSpec> {
    P1W::new(self, 1)
  }
  #[doc = "Bit 2 - Output Write Disable."]
  #[inline(always)]
  pub fn p2(&mut self) -> P2W<'_, OwdrSpec> {
    P2W::new(self, 2)
  }
  #[doc = "Bit 3 - Output Write Disable."]
  #[inline(always)]
  pub fn p3(&mut self) -> P3W<'_, OwdrSpec> {
    P3W::new(self, 3)
  }
  #[doc = "Bit 4 - Output Write Disable."]
  #[inline(always)]
  pub fn p4(&mut self) -> P4W<'_, OwdrSpec> {
    P4W::new(self, 4)
  }
  #[doc = "Bit 5 - Output Write Disable."]
  #[inline(always)]
  pub fn p5(&mut self) -> P5W<'_, OwdrSpec> {
    P5W::new(self, 5)
  }
  #[doc = "Bit 6 - Output Write Disable."]
  #[inline(always)]
  pub fn p6(&mut self) -> P6W<'_, OwdrSpec> {
    P6W::new(self, 6)
  }
  #[doc = "Bit 7 - Output Write Disable."]
  #[inline(always)]
  pub fn p7(&mut self) -> P7W<'_, OwdrSpec> {
    P7W::new(self, 7)
  }
  #[doc = "Bit 8 - Output Write Disable."]
  #[inline(always)]
  pub fn p8(&mut self) -> P8W<'_, OwdrSpec> {
    P8W::new(self, 8)
  }
  #[doc = "Bit 9 - Output Write Disable."]
  #[inline(always)]
  pub fn p9(&mut self) -> P9W<'_, OwdrSpec> {
    P9W::new(self, 9)
  }
  #[doc = "Bit 10 - Output Write Disable."]
  #[inline(always)]
  pub fn p10(&mut self) -> P10W<'_, OwdrSpec> {
    P10W::new(self, 10)
  }
  #[doc = "Bit 11 - Output Write Disable."]
  #[inline(always)]
  pub fn p11(&mut self) -> P11W<'_, OwdrSpec> {
    P11W::new(self, 11)
  }
  #[doc = "Bit 12 - Output Write Disable."]
  #[inline(always)]
  pub fn p12(&mut self) -> P12W<'_, OwdrSpec> {
    P12W::new(self, 12)
  }
  #[doc = "Bit 13 - Output Write Disable."]
  #[inline(always)]
  pub fn p13(&mut self) -> P13W<'_, OwdrSpec> {
    P13W::new(self, 13)
  }
  #[doc = "Bit 14 - Output Write Disable."]
  #[inline(always)]
  pub fn p14(&mut self) -> P14W<'_, OwdrSpec> {
    P14W::new(self, 14)
  }
  #[doc = "Bit 15 - Output Write Disable."]
  #[inline(always)]
  pub fn p15(&mut self) -> P15W<'_, OwdrSpec> {
    P15W::new(self, 15)
  }
  #[doc = "Bit 16 - Output Write Disable."]
  #[inline(always)]
  pub fn p16(&mut self) -> P16W<'_, OwdrSpec> {
    P16W::new(self, 16)
  }
  #[doc = "Bit 17 - Output Write Disable."]
  #[inline(always)]
  pub fn p17(&mut self) -> P17W<'_, OwdrSpec> {
    P17W::new(self, 17)
  }
  #[doc = "Bit 18 - Output Write Disable."]
  #[inline(always)]
  pub fn p18(&mut self) -> P18W<'_, OwdrSpec> {
    P18W::new(self, 18)
  }
  #[doc = "Bit 19 - Output Write Disable."]
  #[inline(always)]
  pub fn p19(&mut self) -> P19W<'_, OwdrSpec> {
    P19W::new(self, 19)
  }
  #[doc = "Bit 20 - Output Write Disable."]
  #[inline(always)]
  pub fn p20(&mut self) -> P20W<'_, OwdrSpec> {
    P20W::new(self, 20)
  }
  #[doc = "Bit 21 - Output Write Disable."]
  #[inline(always)]
  pub fn p21(&mut self) -> P21W<'_, OwdrSpec> {
    P21W::new(self, 21)
  }
  #[doc = "Bit 22 - Output Write Disable."]
  #[inline(always)]
  pub fn p22(&mut self) -> P22W<'_, OwdrSpec> {
    P22W::new(self, 22)
  }
  #[doc = "Bit 23 - Output Write Disable."]
  #[inline(always)]
  pub fn p23(&mut self) -> P23W<'_, OwdrSpec> {
    P23W::new(self, 23)
  }
  #[doc = "Bit 24 - Output Write Disable."]
  #[inline(always)]
  pub fn p24(&mut self) -> P24W<'_, OwdrSpec> {
    P24W::new(self, 24)
  }
  #[doc = "Bit 25 - Output Write Disable."]
  #[inline(always)]
  pub fn p25(&mut self) -> P25W<'_, OwdrSpec> {
    P25W::new(self, 25)
  }
  #[doc = "Bit 26 - Output Write Disable."]
  #[inline(always)]
  pub fn p26(&mut self) -> P26W<'_, OwdrSpec> {
    P26W::new(self, 26)
  }
  #[doc = "Bit 27 - Output Write Disable."]
  #[inline(always)]
  pub fn p27(&mut self) -> P27W<'_, OwdrSpec> {
    P27W::new(self, 27)
  }
  #[doc = "Bit 28 - Output Write Disable."]
  #[inline(always)]
  pub fn p28(&mut self) -> P28W<'_, OwdrSpec> {
    P28W::new(self, 28)
  }
  #[doc = "Bit 29 - Output Write Disable."]
  #[inline(always)]
  pub fn p29(&mut self) -> P29W<'_, OwdrSpec> {
    P29W::new(self, 29)
  }
  #[doc = "Bit 30 - Output Write Disable."]
  #[inline(always)]
  pub fn p30(&mut self) -> P30W<'_, OwdrSpec> {
    P30W::new(self, 30)
  }
  #[doc = "Bit 31 - Output Write Disable."]
  #[inline(always)]
  pub fn p31(&mut self) -> P31W<'_, OwdrSpec> {
    P31W::new(self, 31)
  }
}
