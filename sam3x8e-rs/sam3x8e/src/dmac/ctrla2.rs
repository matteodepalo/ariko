...
impl W {
  #[doc = "Bits 0:15 - Buffer Transfer Size"]
  #[inline(always)]
  pub fn btsize(&mut self) -> BtsizeW<'_, Ctrla2Spec> {
    BtsizeW::new(self, 0)
  }
  #[doc = "Bits 16:18 - Source Chunk Transfer Size."]
  #[inline(always)]
  pub fn scsize(&mut self) -> ScsizeW<'_, Ctrla2Spec> {
    ScsizeW::new(self, 16)
  }
  #[doc = "Bits 20:22 - Destination Chunk Transfer Size"]
  #[inline(always)]
  pub fn dcsize(&mut self) -> DcsizeW<'_, Ctrla2Spec> {
    DcsizeW::new(self, 20)
  }
  #[doc = "Bits 24:25 - Transfer Width for the Source"]
  #[inline(always)]
  pub fn src_width(&mut self) -> SrcWidthW<'_, Ctrla2Spec> {
    SrcWidthW::new(self, 24)
  }
  #[doc = "Bits 28:29 - Transfer Width for the Destination"]
  #[inline(always)]
  pub fn dst_width(&mut self) -> DstWidthW<'_, Ctrla2Spec> {
    DstWidthW::new(self, 28)
  }
  #[doc = "Bit 31"]
  #[inline(always)]
  pub fn done(&mut self) -> DoneW<'_, Ctrla2Spec> {
    DoneW::new(self, 31)
  }
}
