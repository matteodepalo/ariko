...
impl W {
  #[doc = "Bits 0:3 - Source with Peripheral identifier"]
  #[inline(always)]
  pub fn src_per(&mut self) -> SrcPerW<'_, Cfg5Spec> {
    SrcPerW::new(self, 0)
  }
  #[doc = "Bits 4:7 - Destination with Peripheral identifier"]
  #[inline(always)]
  pub fn dst_per(&mut self) -> DstPerW<'_, Cfg5Spec> {
    DstPerW::new(self, 4)
  }
  #[doc = "Bit 9 - Software or Hardware Selection for the Source"]
  #[inline(always)]
  pub fn src_h2sel(&mut self) -> SrcH2selW<'_, Cfg5Spec> {
    SrcH2selW::new(self, 9)
  }
  #[doc = "Bit 13 - Software or Hardware Selection for the Destination"]
  #[inline(always)]
  pub fn dst_h2sel(&mut self) -> DstH2selW<'_, Cfg5Spec> {
    DstH2selW::new(self, 13)
  }
  #[doc = "Bit 16 - Stop On Done"]
  #[inline(always)]
  pub fn sod(&mut self) -> SodW<'_, Cfg5Spec> {
    SodW::new(self, 16)
  }
  #[doc = "Bit 20 - Interface Lock"]
  #[inline(always)]
  pub fn lock_if(&mut self) -> LockIfW<'_, Cfg5Spec> {
    LockIfW::new(self, 20)
  }
  #[doc = "Bit 21 - Bus Lock"]
  #[inline(always)]
  pub fn lock_b(&mut self) -> LockBW<'_, Cfg5Spec> {
    LockBW::new(self, 21)
  }
  #[doc = "Bit 22 - Master Interface Arbiter Lock"]
  #[inline(always)]
  pub fn lock_if_l(&mut self) -> LockIfLW<'_, Cfg5Spec> {
    LockIfLW::new(self, 22)
  }
  #[doc = "Bits 24:26 - AHB Protection"]
  #[inline(always)]
  pub fn ahb_prot(&mut self) -> AhbProtW<'_, Cfg5Spec> {
    AhbProtW::new(self, 24)
  }
  #[doc = "Bits 28:29 - FIFO Configuration"]
  #[inline(always)]
  pub fn fifocfg(&mut self) -> FifocfgW<'_, Cfg5Spec> {
