...
impl W {
  #[doc = "Bit 0 - Source Chunk Request"]
  #[inline(always)]
  pub fn screq0(&mut self) -> Screq0W<'_, CreqSpec> {
    Screq0W::new(self, 0)
  }
  #[doc = "Bit 1 - Destination Chunk Request"]
  #[inline(always)]
  pub fn dcreq0(&mut self) -> Dcreq0W<'_, CreqSpec> {
    Dcreq0W::new(self, 1)
  }
  #[doc = "Bit 2 - Source Chunk Request"]
  #[inline(always)]
  pub fn screq1(&mut self) -> Screq1W<'_, CreqSpec> {
    Screq1W::new(self, 2)
  }
  #[doc = "Bit 3 - Destination Chunk Request"]
  #[inline(always)]
  pub fn dcreq1(&mut self) -> Dcreq1W<'_, CreqSpec> {
    Dcreq1W::new(self, 3)
  }
  #[doc = "Bit 4 - Source Chunk Request"]
  #[inline(always)]
  pub fn screq2(&mut self) -> Screq2W<'_, CreqSpec> {
    Screq2W::new(self, 4)
  }
  #[doc = "Bit 5 - Destination Chunk Request"]
  #[inline(always)]
  pub fn dcreq2(&mut self) -> Dcreq2W<'_, CreqSpec> {
    Dcreq2W::new(self, 5)
  }
  #[doc = "Bit 6 - Source Chunk Request"]
  #[inline(always)]
  pub fn screq3(&mut self) -> Screq3W<'_, CreqSpec> {
    Screq3W::new(self, 6)
  }
  #[doc = "Bit 7 - Destination Chunk Request"]
  #[inline(always)]
  pub fn dcreq3(&mut self) -> Dcreq3W<'_, CreqSpec> {
    Dcreq3W::new(self, 7)
  }
  #[doc = "Bit 8 - Source Chunk Request"]
  #[inline(always)]
  pub fn screq4(&mut self) -> Screq4W<'_, CreqSpec> {
    Screq4W::new(self, 8)
  }
  #[doc = "Bit 9 - Destination Chunk Request"]
  #[inline(always)]
  pub fn dcreq4(&mut self) -> Dcreq4W<'_, CreqSpec> {
    Dcreq4W::new(self, 9)
  }
  #[doc = "Bit 10 - Source Chunk Request"]
  #[inline(always)]
  pub fn screq5(&mut self) -> Screq5W<'_, CreqSpec> {
    Screq5W::new(self, 10)
  }
  #[doc = "Bit 11 - Destination Chunk Request"]
  #[inline(always)]
  pub fn dcreq5(&mut self) -> Dcreq5W<'_, CreqSpec> {
    Dcreq5W::new(self, 11)
  }
}
