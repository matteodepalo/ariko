...
impl W {
  #[doc = "Bit 16 - Source Address Descriptor"]
  #[inline(always)]
  pub fn src_dscr(&mut self) -> SrcDscrW<'_, Ctrlb5Spec> {
    SrcDscrW::new(self, 16)
  }
  #[doc = "Bit 20 - Destination Address Descriptor"]
  #[inline(always)]
  pub fn dst_dscr(&mut self) -> DstDscrW<'_, Ctrlb5Spec> {
    DstDscrW::new(self, 20)
  }
  #[doc = "Bits 21:23 - Flow Control"]
  #[inline(always)]
  pub fn fc(&mut self) -> FcW<'_, Ctrlb5Spec> {
    FcW::new(self, 21)
  }
  #[doc = "Bits 24:25 - Incrementing, Decrementing or Fixed Address for the Source"]
  #[inline(always)]
  pub fn src_incr(&mut self) -> SrcIncrW<'_, Ctrlb5Spec> {
    SrcIncrW::new(self, 24)
  }
  #[doc = "Bits 28:29 - Incrementing, Decrementing or Fixed Address for the Destination"]
  #[inline(always)]
  pub fn dst_incr(&mut self) -> DstIncrW<'_, Ctrlb5Spec> {
    DstIncrW::new(self, 28)
  }
  #[doc = "Bit 30"]
  #[inline(always)]
  pub fn ien(&mut self) -> IenW<'_, Ctrlb5Spec> {
    IenW::new(self, 30)
  }
}
