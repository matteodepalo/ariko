...
impl W {
  ...
  #[inline(always)]
  pub fn btc0(&mut self) -> Btc0W<'_, EbcidrSpec> {
    Btc0W::new(self, 0)
  }
  #[doc = "Bit 1 - Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn btc1(&mut self) -> Btc1W<'_, EbcidrSpec> {
    Btc1W::new(self, 1)
  }
  #[doc = "Bit 2 - Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn btc2(&mut self) -> Btc2W<'_, EbcidrSpec> {
    Btc2W::new(self, 2)
  }
  #[doc = "Bit 3 - Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn btc3(&mut self) -> Btc3W<'_, EbcidrSpec> {
    Btc3W::new(self, 3)
  }
  #[doc = "Bit 4 - Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn btc4(&mut self) -> Btc4W<'_, EbcidrSpec> {
    Btc4W::new(self, 4)
  }
  #[doc = "Bit 5 - Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn btc5(&mut self) -> Btc5W<'_, EbcidrSpec> {
    Btc5W::new(self, 5)
  }
  #[doc = "Bit 8 - Chained Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn cbtc0(&mut self) -> Cbtc0W<'_, EbcidrSpec> {
    Cbtc0W::new(self, 8)
  }
  #[doc = "Bit 9 - Chained Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn cbtc1(&mut self) -> Cbtc1W<'_, EbcidrSpec> {
    Cbtc1W::new(self, 9)
  }
  #[doc = "Bit 10 - Chained Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn cbtc2(&mut self) -> Cbtc2W<'_, EbcidrSpec> {
    Cbtc2W::new(self, 10)
  }
  #[doc = "Bit 11 - Chained Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn cbtc3(&mut self) -> Cbtc3W<'_, EbcidrSpec> {
    Cbtc3W::new(self, 11)
  }
  #[doc = "Bit 12 - Chained Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn cbtc4(&mut self) -> Cbtc4W<'_, EbcidrSpec> {
    Cbtc4W::new(self, 12)
  }
  #[doc = "Bit 13 - Chained Buffer Transfer Completed \\[5:0\\]"]
  #[inline(always)]
  pub fn cbtc5(&mut self) -> Cbtc5W<'_, EbcidrSpec> {
    Cbtc5W::new(self, 13)
  }
  #[doc = "Bit 16 - Access Error \\[5:0\\]"]
  #[inline(always)]
  pub fn err0(&mut self) -> Err0W<'_, EbcidrSpec> {
    Err0W::new(self, 16)
  }
  #[doc = "Bit 17 - Access Error \\[5:0\\]"]
  #[inline(always)]
  pub fn err1(&mut self) -> Err1W<'_, EbcidrSpec> {
    Err1W::new(self, 17)
  }
  #[doc = "Bit 18 - Access Error \\[5:0\\]"]
  #[inline(always)]
  pub fn err2(&mut self) -> Err2W<'_, EbcidrSpec> {
    Err2W::new(self, 18)
  }
  #[doc = "Bit 19 - Access Error \\[5:0\\]"]
  #[inline(always)]
  pub fn err3(&mut self) -> Err3W<'_, EbcidrSpec> {
    Err3W::new(self, 19)
  }
  #[doc = "Bit 20 - Access Error \\[5:0\\]"]
  #[inline(always)]
  pub fn err4(&mut self) -> Err4W<'_, EbcidrSpec> {
    Err4W::new(self, 20)
  }
  #[doc = "Bit 21 - Access Error \\[5:0\\]"]
  #[inline(always)]
  pub fn err5(&mut self) -> Err5W<'_, EbcidrSpec> {
    Err5W::new(self, 21)
  }
}
