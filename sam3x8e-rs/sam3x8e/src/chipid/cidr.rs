...
pub enum Arch {
  ...
  Sam3uxE = 129,
  #[doc = "131: SAM3AxC/SAM4AxC Series (100-pin version)"]
  Sam3axCSam4axC = 131,
  #[doc = "132: SAM3XxC/SAM4XxC Series (100-pin version)"]
  Sam3xxCSam4xxC = 132,
  #[doc = "133: SAM3XxE/SAM4XxE Series (144-pin version)"]
  Sam3xxESam4xxE = 133,
  #[doc = "134: SAM3XxG/SAM4XxG Series (208/217-pin version)"]
  Sam3xxGSam4xxG = 134,
  #[doc = "136: SAM3SxA/SAM4SxA Series (48-pin version)"]
  Sam3sxASam4sxA = 136,
  #[doc = "137: SAM3SxB/SAM4SxB Series (64-pin version)"]
  Sam3sxBSam4sxB = 137,
  #[doc = "138: SAM3SxC/SAM4SxC Series (100-pin version)"]
  Sam3sxCSam4sxC = 138,
...
impl ArchR {
  ...
  pub const fn variant(&self) -> Option<Arch> {
    match self.bits {
      ...
      131 => Some(Arch::Sam3axCSam4axC),
      132 => Some(Arch::Sam3xxCSam4xxC),
      133 => Some(Arch::Sam3xxESam4xxE),
      134 => Some(Arch::Sam3xxGSam4xxG),
      136 => Some(Arch::Sam3sxASam4sxA),
      137 => Some(Arch::Sam3sxBSam4sxB),
      138 => Some(Arch::Sam3sxCSam4sxC),
      146 => Some(Arch::At91x92),
      147 => Some(Arch::Sam3nxA),
      148 => Some(Arch::Sam3nxB),
      149 => Some(Arch::Sam3nxC),
  ...
  #[doc = "SAM3AxC/SAM4AxC Series (100-pin version)"]
  #[inline(always)]
  pub fn is_sam3ax_c_sam4ax_c(&self) -> bool {
    *self == Arch::Sam3axCSam4axC
  }
  #[doc = "SAM3XxC/SAM4XxC Series (100-pin version)"]
  #[inline(always)]
  pub fn is_sam3xx_c_sam4xx_c(&self) -> bool {
    *self == Arch::Sam3xxCSam4xxC
  }
  #[doc = "SAM3XxE/SAM4XxE Series (144-pin version)"]
  #[inline(always)]
  pub fn is_sam3xx_e_sam4xx_e(&self) -> bool {
    *self == Arch::Sam3xxESam4xxE
  }
  #[doc = "SAM3XxG/SAM4XxG Series (208/217-pin version)"]
  #[inline(always)]
  pub fn is_sam3xx_g_sam4xx_g(&self) -> bool {
    *self == Arch::Sam3xxGSam4xxG
  }
  #[doc = "SAM3SxA/SAM4SxA Series (48-pin version)"]
  #[inline(always)]
  pub fn is_sam3sx_a_sam4sx_a(&self) -> bool {
    *self == Arch::Sam3sxASam4sxA
  }
  #[doc = "SAM3SxB/SAM4SxB Series (64-pin version)"]
  #[inline(always)]
  pub fn is_sam3sx_b_sam4sx_b(&self) -> bool {
    *self == Arch::Sam3sxBSam4sxB
  }
  #[doc = "SAM3SxC/SAM4SxC Series (100-pin version)"]
  #[inline(always)]
  pub fn is_sam3sx_c_sam4sx_c(&self) -> bool {
    *self == Arch::Sam3sxCSam4sxC
  }
  #[doc = "AT91x92 Series"]
  #[inline(always)]
