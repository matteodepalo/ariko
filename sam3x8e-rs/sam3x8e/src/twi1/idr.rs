...
impl W {
  ...
  #[inline(always)]
  pub fn txcomp(&mut self) -> TxcompW<'_, IdrSpec> {
    TxcompW::new(self, 0)
  }
  ...
  #[inline(always)]
  pub fn svacc(&mut self) -> SvaccW<'_, IdrSpec> {
    SvaccW::new(self, 4)
  }
  #[doc = "Bit 5 - General Call Access Interrupt Disable"]
  #[inline(always)]
  pub fn gacc(&mut self) -> GaccW<'_, IdrSpec> {
    GaccW::new(self, 5)
  }
  ...
  #[inline(always)]
  pub fn nack(&mut self) -> NackW<'_, IdrSpec> {
    NackW::new(self, 8)
  }
  #[doc = "Bit 9 - Arbitration Lost Interrupt Disable"]
  #[inline(always)]
  pub fn arblst(&mut self) -> ArblstW<'_, IdrSpec> {
    ArblstW::new(self, 9)
  }
  #[doc = "Bit 10 - Clock Wait State Interrupt Disable"]
  #[inline(always)]
  pub fn scl_ws(&mut self) -> SclWsW<'_, IdrSpec> {
    SclWsW::new(self, 10)
  }
  #[doc = "Bit 11 - End Of Slave Access Interrupt Disable"]
  #[inline(always)]
  pub fn eosacc(&mut self) -> EosaccW<'_, IdrSpec> {
    EosaccW::new(self, 11)
  }
