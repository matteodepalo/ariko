...
impl W {
  ...
  #[inline(always)]
  pub fn rxrdy(&mut self) -> RxrdyW<'_, SpiModeIerSpiModeSpec> {
    RxrdyW::new(self, 0)
  }
  #[doc = "Bit 1 - TXRDY Interrupt Enable"]
  #[inline(always)]
  pub fn txrdy(&mut self) -> TxrdyW<'_, SpiModeIerSpiModeSpec> {
    TxrdyW::new(self, 1)
  }
  #[doc = "Bit 5 - Overrun Error Interrupt Enable"]
  #[inline(always)]
  pub fn ovre(&mut self) -> OvreW<'_, SpiModeIerSpiModeSpec> {
    OvreW::new(self, 5)
  }
  #[doc = "Bit 9 - TXEMPTY Interrupt Enable"]
  #[inline(always)]
  pub fn txempty(&mut self) -> TxemptyW<'_, SpiModeIerSpiModeSpec> {
    TxemptyW::new(self, 9)
  }
  #[doc = "Bit 10 - SPI Underrun Error Interrupt Enable"]
  #[inline(always)]
  pub fn unre(&mut self) -> UnreW<'_, SpiModeIerSpiModeSpec> {
    UnreW::new(self, 10)
  }
}
