...
impl W {
  #[doc = "Bits 0:3 - USART Mode of Operation"]
  #[inline(always)]
  pub fn usart_mode(&mut self) -> UsartModeW<'_, SpiModeMrSpiModeSpec> {
    UsartModeW::new(self, 0)
  }
  #[doc = "Bits 4:5 - Clock Selection"]
  #[inline(always)]
  pub fn usclks(&mut self) -> UsclksW<'_, SpiModeMrSpiModeSpec> {
    UsclksW::new(self, 4)
  }
  #[doc = "Bits 6:7 - Character Length."]
  #[inline(always)]
  pub fn chrl(&mut self) -> ChrlW<'_, SpiModeMrSpiModeSpec> {
    ChrlW::new(self, 6)
  }
  #[doc = "Bit 8 - SPI Clock Phase"]
  #[inline(always)]
  pub fn cpha(&mut self) -> CphaW<'_, SpiModeMrSpiModeSpec> {
    CphaW::new(self, 8)
  }
  #[doc = "Bit 16 - SPI Clock Polarity"]
  #[inline(always)]
  pub fn cpol(&mut self) -> CpolW<'_, SpiModeMrSpiModeSpec> {
    CpolW::new(self, 16)
  }
  #[doc = "Bit 20 - Wait Read Data Before Transfer"]
  #[inline(always)]
  pub fn wrdbt(&mut self) -> WrdbtW<'_, SpiModeMrSpiModeSpec> {
    WrdbtW::new(self, 20)
  }
}
