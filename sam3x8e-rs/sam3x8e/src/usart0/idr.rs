...
impl W {
  ...
  #[inline(always)]
  pub fn rxbrk(&mut self) -> RxbrkW<'_, IdrSpec> {
    RxbrkW::new(self, 2)
  }
  ...
  #[inline(always)]
  pub fn timeout(&mut self) -> TimeoutW<'_, IdrSpec> {
    TimeoutW::new(self, 8)
  }
  ...
  #[inline(always)]
  pub fn iter(&mut self) -> IterW<'_, IdrSpec> {
    IterW::new(self, 10)
  }
  ...
  #[inline(always)]
  pub fn ctsic(&mut self) -> CtsicW<'_, IdrSpec> {
    CtsicW::new(self, 19)
  }
  #[doc = "Bit 24 - Manchester Error Interrupt Disable"]
  #[inline(always)]
  pub fn mane(&mut self) -> ManeW<'_, IdrSpec> {
    ManeW::new(self, 24)
  }
}
