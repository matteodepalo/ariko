...
impl W {
  #[doc = "Bit 0 - Update Request Time Register"]
  #[inline(always)]
  pub fn updtim(&mut self) -> UpdtimW<'_, CrSpec> {
    UpdtimW::new(self, 0)
  }
  #[doc = "Bit 1 - Update Request Calendar Register"]
  #[inline(always)]
  pub fn updcal(&mut self) -> UpdcalW<'_, CrSpec> {
    UpdcalW::new(self, 1)
  }
  #[doc = "Bits 8:9 - Time Event Selection"]
  #[inline(always)]
  pub fn timevsel(&mut self) -> TimevselW<'_, CrSpec> {
    TimevselW::new(self, 8)
  }
  #[doc = "Bits 16:17 - Calendar Event Selection"]
  #[inline(always)]
  pub fn calevsel(&mut self) -> CalevselW<'_, CrSpec> {
