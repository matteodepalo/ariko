...
impl W {
  #[doc = "Bits 0:6 - Second Alarm"]
  #[inline(always)]
  pub fn sec(&mut self) -> SecW<'_, TimalrSpec> {
    SecW::new(self, 0)
  }
  #[doc = "Bit 7 - Second Alarm Enable"]
  #[inline(always)]
  pub fn secen(&mut self) -> SecenW<'_, TimalrSpec> {
    SecenW::new(self, 7)
  }
  #[doc = "Bits 8:14 - Minute Alarm"]
  #[inline(always)]
  pub fn min(&mut self) -> MinW<'_, TimalrSpec> {
    MinW::new(self, 8)
  }
  #[doc = "Bit 15 - Minute Alarm Enable"]
  #[inline(always)]
  pub fn minen(&mut self) -> MinenW<'_, TimalrSpec> {
    MinenW::new(self, 15)
  }
  #[doc = "Bits 16:21 - Hour Alarm"]
  #[inline(always)]
  pub fn hour(&mut self) -> HourW<'_, TimalrSpec> {
    HourW::new(self, 16)
  }
  #[doc = "Bit 22 - AM/PM Indicator"]
  #[inline(always)]
  pub fn ampm(&mut self) -> AmpmW<'_, TimalrSpec> {
    AmpmW::new(self, 22)
  }
  #[doc = "Bit 23 - Hour Alarm Enable"]
  #[inline(always)]
  pub fn houren(&mut self) -> HourenW<'_, TimalrSpec> {
    HourenW::new(self, 23)
  }
}
