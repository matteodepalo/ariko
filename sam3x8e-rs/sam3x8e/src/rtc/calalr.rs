...
impl W {
  #[doc = "Bits 16:20 - Month Alarm"]
  #[inline(always)]
  pub fn month(&mut self) -> MonthW<'_, CalalrSpec> {
    MonthW::new(self, 16)
  }
  #[doc = "Bit 23 - Month Alarm Enable"]
  #[inline(always)]
  pub fn mthen(&mut self) -> MthenW<'_, CalalrSpec> {
    MthenW::new(self, 23)
  }
  #[doc = "Bits 24:29 - Date Alarm"]
  #[inline(always)]
  pub fn date(&mut self) -> DateW<'_, CalalrSpec> {
    DateW::new(self, 24)
  }
  #[doc = "Bit 31 - Date Alarm Enable"]
  #[inline(always)]
  pub fn dateen(&mut self) -> DateenW<'_, CalalrSpec> {
    DateenW::new(self, 31)
  }
}
