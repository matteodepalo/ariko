...
impl W {
  #[doc = "Bits 0:1 - External Clock Signal 0 Selection"]
  #[inline(always)]
  pub fn tc0xc0s(&mut self) -> Tc0xc0sW<'_, BmrSpec> {
    Tc0xc0sW::new(self, 0)
  }
  #[doc = "Bits 2:3 - External Clock Signal 1 Selection"]
  #[inline(always)]
  pub fn tc1xc1s(&mut self) -> Tc1xc1sW<'_, BmrSpec> {
    Tc1xc1sW::new(self, 2)
  }
  #[doc = "Bits 4:5 - External Clock Signal 2 Selection"]
  #[inline(always)]
  pub fn tc2xc2s(&mut self) -> Tc2xc2sW<'_, BmrSpec> {
    Tc2xc2sW::new(self, 4)
  }
  #[doc = "Bit 8 - Quadrature Decoder ENabled"]
  #[inline(always)]
  pub fn qden(&mut self) -> QdenW<'_, BmrSpec> {
    QdenW::new(self, 8)
  }
  #[doc = "Bit 9 - POSition ENabled"]
  #[inline(always)]
  pub fn posen(&mut self) -> PosenW<'_, BmrSpec> {
    PosenW::new(self, 9)
  }
  #[doc = "Bit 10 - SPEED ENabled"]
  #[inline(always)]
  pub fn speeden(&mut self) -> SpeedenW<'_, BmrSpec> {
    SpeedenW::new(self, 10)
  }
  #[doc = "Bit 11 - Quadrature Decoding TRANSparent"]
  #[inline(always)]
  pub fn qdtrans(&mut self) -> QdtransW<'_, BmrSpec> {
    QdtransW::new(self, 11)
  }
  #[doc = "Bit 12 - EDGe on PHA count mode"]
  #[inline(always)]
  pub fn edgpha(&mut self) -> EdgphaW<'_, BmrSpec> {
    EdgphaW::new(self, 12)
  }
  #[doc = "Bit 13 - INVerted phA"]
  #[inline(always)]
  pub fn inva(&mut self) -> InvaW<'_, BmrSpec> {
    InvaW::new(self, 13)
  }
  #[doc = "Bit 14 - INVerted phB"]
  #[inline(always)]
  pub fn invb(&mut self) -> InvbW<'_, BmrSpec> {
    InvbW::new(self, 14)
  }
  #[doc = "Bit 15 - INVerted InDeX"]
  #[inline(always)]
  pub fn invidx(&mut self) -> InvidxW<'_, BmrSpec> {
    InvidxW::new(self, 15)
  }
  #[doc = "Bit 16 - SWAP PHA and PHB"]
  #[inline(always)]
  pub fn swap(&mut self) -> SwapW<'_, BmrSpec> {
    SwapW::new(self, 16)
  }
  #[doc = "Bit 17 - InDeX pin is PHB pin"]
  #[inline(always)]
  pub fn idxphb(&mut self) -> IdxphbW<'_, BmrSpec> {
    IdxphbW::new(self, 17)
  }
  #[doc = "Bit 19"]
  #[inline(always)]
  pub fn filter(&mut self) -> FilterW<'_, BmrSpec> {
    FilterW::new(self, 19)
  }
  #[doc = "Bits 20:25 - MAXimum FILTer"]
  #[inline(always)]
  pub fn maxfilt(&mut self) -> MaxfiltW<'_, BmrSpec> {
