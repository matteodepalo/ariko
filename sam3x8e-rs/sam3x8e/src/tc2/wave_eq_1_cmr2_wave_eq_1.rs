...
impl W {
  #[doc = "Bits 0:2 - Clock Selection"]
  #[inline(always)]
  pub fn tcclks(&mut self) -> TcclksW<'_, WaveEq1Cmr2WaveEq1Spec> {
    TcclksW::new(self, 0)
  }
  #[doc = "Bit 3 - Clock Invert"]
  #[inline(always)]
  pub fn clki(&mut self) -> ClkiW<'_, WaveEq1Cmr2WaveEq1Spec> {
    ClkiW::new(self, 3)
  }
  #[doc = "Bits 4:5 - Burst Signal Selection"]
  #[inline(always)]
  pub fn burst(&mut self) -> BurstW<'_, WaveEq1Cmr2WaveEq1Spec> {
    BurstW::new(self, 4)
  }
  #[doc = "Bit 6 - Counter Clock Stopped with RC Compare"]
  #[inline(always)]
  pub fn cpcstop(&mut self) -> CpcstopW<'_, WaveEq1Cmr2WaveEq1Spec> {
    CpcstopW::new(self, 6)
  }
  #[doc = "Bit 7 - Counter Clock Disable with RC Compare"]
  #[inline(always)]
  pub fn cpcdis(&mut self) -> CpcdisW<'_, WaveEq1Cmr2WaveEq1Spec> {
    CpcdisW::new(self, 7)
  }
  #[doc = "Bits 8:9 - External Event Edge Selection"]
  #[inline(always)]
  pub fn eevtedg(&mut self) -> EevtedgW<'_, WaveEq1Cmr2WaveEq1Spec> {
    EevtedgW::new(self, 8)
  }
  #[doc = "Bits 10:11 - External Event Selection"]
  #[inline(always)]
  pub fn eevt(&mut self) -> EevtW<'_, WaveEq1Cmr2WaveEq1Spec> {
    EevtW::new(self, 10)
  }
  #[doc = "Bit 12 - External Event Trigger Enable"]
  #[inline(always)]
  pub fn enetrg(&mut self) -> EnetrgW<'_, WaveEq1Cmr2WaveEq1Spec> {
    EnetrgW::new(self, 12)
  }
  #[doc = "Bits 13:14 - Waveform Selection"]
  #[inline(always)]
  pub fn wavsel(&mut self) -> WavselW<'_, WaveEq1Cmr2WaveEq1Spec> {
    WavselW::new(self, 13)
  }
  #[doc = "Bit 15 - Waveform Mode"]
  #[inline(always)]
  pub fn wave(&mut self) -> WaveW<'_, WaveEq1Cmr2WaveEq1Spec> {
    WaveW::new(self, 15)
  }
  #[doc = "Bits 16:17 - RA Compare Effect on TIOA"]
  #[inline(always)]
  pub fn acpa(&mut self) -> AcpaW<'_, WaveEq1Cmr2WaveEq1Spec> {
    AcpaW::new(self, 16)
  }
  #[doc = "Bits 18:19 - RC Compare Effect on TIOA"]
  #[inline(always)]
  pub fn acpc(&mut self) -> AcpcW<'_, WaveEq1Cmr2WaveEq1Spec> {
    AcpcW::new(self, 18)
  }
  #[doc = "Bits 20:21 - External Event Effect on TIOA"]
  #[inline(always)]
  pub fn aeevt(&mut self) -> AeevtW<'_, WaveEq1Cmr2WaveEq1Spec> {
    AeevtW::new(self, 20)
  }
  #[doc = "Bits 22:23 - Software Trigger Effect on TIOA"]
  #[inline(always)]
  pub fn aswtrg(&mut self) -> AswtrgW<'_, WaveEq1Cmr2WaveEq1Spec> {
    AswtrgW::new(self, 22)
  }
  #[doc = "Bits 24:25 - RB Compare Effect on TIOB"]
  #[inline(always)]
  pub fn bcpb(&mut self) -> BcpbW<'_, WaveEq1Cmr2WaveEq1Spec> {
    BcpbW::new(self, 24)
  }
  #[doc = "Bits 26:27 - RC Compare Effect on TIOB"]
  #[inline(always)]
  pub fn bcpc(&mut self) -> BcpcW<'_, WaveEq1Cmr2WaveEq1Spec> {
    BcpcW::new(self, 26)
  }
  #[doc = "Bits 28:29 - External Event Effect on TIOB"]
  #[inline(always)]
  pub fn beevt(&mut self) -> BeevtW<'_, WaveEq1Cmr2WaveEq1Spec> {
    BeevtW::new(self, 28)
  }
  #[doc = "Bits 30:31 - Software Trigger Effect on TIOB"]
  #[inline(always)]
  pub fn bswtrg(&mut self) -> BswtrgW<'_, WaveEq1Cmr2WaveEq1Spec> {
    BswtrgW::new(self, 30)
  }
}
