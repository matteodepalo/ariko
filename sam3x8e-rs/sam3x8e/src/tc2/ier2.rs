...
impl W {
  ...
  #[inline(always)]
  pub fn covfs(&mut self) -> CovfsW<'_, Ier2Spec> {
    CovfsW::new(self, 0)
  }
  #[doc = "Bit 1 - Load Overrun"]
  #[inline(always)]
  pub fn lovrs(&mut self) -> LovrsW<'_, Ier2Spec> {
    LovrsW::new(self, 1)
  }
  #[doc = "Bit 2 - RA Compare"]
  #[inline(always)]
  pub fn cpas(&mut self) -> CpasW<'_, Ier2Spec> {
    CpasW::new(self, 2)
  }
  #[doc = "Bit 3 - RB Compare"]
  #[inline(always)]
  pub fn cpbs(&mut self) -> CpbsW<'_, Ier2Spec> {
    CpbsW::new(self, 3)
  }
  #[doc = "Bit 4 - RC Compare"]
  #[inline(always)]
  pub fn cpcs(&mut self) -> CpcsW<'_, Ier2Spec> {
    CpcsW::new(self, 4)
  }
  #[doc = "Bit 5 - RA Loading"]
  #[inline(always)]
  pub fn ldras(&mut self) -> LdrasW<'_, Ier2Spec> {
    LdrasW::new(self, 5)
  }
  #[doc = "Bit 6 - RB Loading"]
  #[inline(always)]
  pub fn ldrbs(&mut self) -> LdrbsW<'_, Ier2Spec> {
    LdrbsW::new(self, 6)
  }
  #[doc = "Bit 7 - External Trigger"]
  #[inline(always)]
  pub fn etrgs(&mut self) -> EtrgsW<'_, Ier2Spec> {
    EtrgsW::new(self, 7)
  }
}
