...
impl W {
  #[doc = "Bit 0 - Wake Up Input Enable 0"]
  #[inline(always)]
  pub fn wkupen0(&mut self) -> Wkupen0W<'_, WuirSpec> {
    Wkupen0W::new(self, 0)
  }
  #[doc = "Bit 1 - Wake Up Input Enable 1"]
  #[inline(always)]
  pub fn wkupen1(&mut self) -> Wkupen1W<'_, WuirSpec> {
    Wkupen1W::new(self, 1)
  }
  #[doc = "Bit 2 - Wake Up Input Enable 2"]
  #[inline(always)]
  pub fn wkupen2(&mut self) -> Wkupen2W<'_, WuirSpec> {
    Wkupen2W::new(self, 2)
  }
  #[doc = "Bit 3 - Wake Up Input Enable 3"]
  #[inline(always)]
  pub fn wkupen3(&mut self) -> Wkupen3W<'_, WuirSpec> {
    Wkupen3W::new(self, 3)
  }
  #[doc = "Bit 4 - Wake Up Input Enable 4"]
  #[inline(always)]
  pub fn wkupen4(&mut self) -> Wkupen4W<'_, WuirSpec> {
    Wkupen4W::new(self, 4)
  }
  #[doc = "Bit 5 - Wake Up Input Enable 5"]
  #[inline(always)]
  pub fn wkupen5(&mut self) -> Wkupen5W<'_, WuirSpec> {
    Wkupen5W::new(self, 5)
  }
  #[doc = "Bit 6 - Wake Up Input Enable 6"]
  #[inline(always)]
  pub fn wkupen6(&mut self) -> Wkupen6W<'_, WuirSpec> {
    Wkupen6W::new(self, 6)
  }
  #[doc = "Bit 7 - Wake Up Input Enable 7"]
  #[inline(always)]
  pub fn wkupen7(&mut self) -> Wkupen7W<'_, WuirSpec> {
    Wkupen7W::new(self, 7)
  }
  #[doc = "Bit 8 - Wake Up Input Enable 8"]
  #[inline(always)]
  pub fn wkupen8(&mut self) -> Wkupen8W<'_, WuirSpec> {
    Wkupen8W::new(self, 8)
  }
  #[doc = "Bit 9 - Wake Up Input Enable 9"]
  #[inline(always)]
  pub fn wkupen9(&mut self) -> Wkupen9W<'_, WuirSpec> {
    Wkupen9W::new(self, 9)
  }
  #[doc = "Bit 10 - Wake Up Input Enable 10"]
  #[inline(always)]
  pub fn wkupen10(&mut self) -> Wkupen10W<'_, WuirSpec> {
    Wkupen10W::new(self, 10)
  }
  #[doc = "Bit 11 - Wake Up Input Enable 11"]
  #[inline(always)]
  pub fn wkupen11(&mut self) -> Wkupen11W<'_, WuirSpec> {
    Wkupen11W::new(self, 11)
  }
  #[doc = "Bit 12 - Wake Up Input Enable 12"]
  #[inline(always)]
  pub fn wkupen12(&mut self) -> Wkupen12W<'_, WuirSpec> {
    Wkupen12W::new(self, 12)
  }
  #[doc = "Bit 13 - Wake Up Input Enable 13"]
  #[inline(always)]
  pub fn wkupen13(&mut self) -> Wkupen13W<'_, WuirSpec> {
    Wkupen13W::new(self, 13)
  }
  #[doc = "Bit 14 - Wake Up Input Enable 14"]
  #[inline(always)]
  pub fn wkupen14(&mut self) -> Wkupen14W<'_, WuirSpec> {
    Wkupen14W::new(self, 14)
  }
  #[doc = "Bit 15 - Wake Up Input Enable 15"]
  #[inline(always)]
  pub fn wkupen15(&mut self) -> Wkupen15W<'_, WuirSpec> {
    Wkupen15W::new(self, 15)
  }
  #[doc = "Bit 16 - Wake Up Input Type 0"]
  #[inline(always)]
  pub fn wkupt0(&mut self) -> Wkupt0W<'_, WuirSpec> {
    Wkupt0W::new(self, 16)
  }
  #[doc = "Bit 17 - Wake Up Input Type 1"]
  #[inline(always)]
  pub fn wkupt1(&mut self) -> Wkupt1W<'_, WuirSpec> {
    Wkupt1W::new(self, 17)
  }
  #[doc = "Bit 18 - Wake Up Input Type 2"]
  #[inline(always)]
  pub fn wkupt2(&mut self) -> Wkupt2W<'_, WuirSpec> {
    Wkupt2W::new(self, 18)
  }
  #[doc = "Bit 19 - Wake Up Input Type 3"]
  #[inline(always)]
  pub fn wkupt3(&mut self) -> Wkupt3W<'_, WuirSpec> {
    Wkupt3W::new(self, 19)
  }
  #[doc = "Bit 20 - Wake Up Input Type 4"]
  #[inline(always)]
  pub fn wkupt4(&mut self) -> Wkupt4W<'_, WuirSpec> {
    Wkupt4W::new(self, 20)
  }
  #[doc = "Bit 21 - Wake Up Input Type 5"]
  #[inline(always)]
  pub fn wkupt5(&mut self) -> Wkupt5W<'_, WuirSpec> {
    Wkupt5W::new(self, 21)
  }
  #[doc = "Bit 22 - Wake Up Input Type 6"]
  #[inline(always)]
  pub fn wkupt6(&mut self) -> Wkupt6W<'_, WuirSpec> {
    Wkupt6W::new(self, 22)
  }
  #[doc = "Bit 23 - Wake Up Input Type 7"]
  #[inline(always)]
  pub fn wkupt7(&mut self) -> Wkupt7W<'_, WuirSpec> {
    Wkupt7W::new(self, 23)
  }
  #[doc = "Bit 24 - Wake Up Input Type 8"]
  #[inline(always)]
  pub fn wkupt8(&mut self) -> Wkupt8W<'_, WuirSpec> {
    Wkupt8W::new(self, 24)
  }
  #[doc = "Bit 25 - Wake Up Input Type 9"]
  #[inline(always)]
  pub fn wkupt9(&mut self) -> Wkupt9W<'_, WuirSpec> {
    Wkupt9W::new(self, 25)
  }
  #[doc = "Bit 26 - Wake Up Input Type 10"]
  #[inline(always)]
  pub fn wkupt10(&mut self) -> Wkupt10W<'_, WuirSpec> {
    Wkupt10W::new(self, 26)
  }
  #[doc = "Bit 27 - Wake Up Input Type 11"]
  #[inline(always)]
  pub fn wkupt11(&mut self) -> Wkupt11W<'_, WuirSpec> {
    Wkupt11W::new(self, 27)
  }
  #[doc = "Bit 28 - Wake Up Input Type 12"]
  #[inline(always)]
  pub fn wkupt12(&mut self) -> Wkupt12W<'_, WuirSpec> {
    Wkupt12W::new(self, 28)
  }
  #[doc = "Bit 29 - Wake Up Input Type 13"]
  #[inline(always)]
  pub fn wkupt13(&mut self) -> Wkupt13W<'_, WuirSpec> {
    Wkupt13W::new(self, 29)
  }
  #[doc = "Bit 30 - Wake Up Input Type 14"]
  #[inline(always)]
  pub fn wkupt14(&mut self) -> Wkupt14W<'_, WuirSpec> {
    Wkupt14W::new(self, 30)
  }
  #[doc = "Bit 31 - Wake Up Input Type 15"]
  #[inline(always)]
  pub fn wkupt15(&mut self) -> Wkupt15W<'_, WuirSpec> {
