...
impl W {
  ...
  #[inline(always)]
  pub fn rdrf(&mut self) -> RdrfW<'_, IerSpec> {
    RdrfW::new(self, 0)
  }
  #[doc = "Bit 1 - SPI Transmit Data Register Empty Interrupt Enable"]
  #[inline(always)]
  pub fn tdre(&mut self) -> TdreW<'_, IerSpec> {
    TdreW::new(self, 1)
  }
  ...
  #[inline(always)]
  pub fn ovres(&mut self) -> OvresW<'_, IerSpec> {
    OvresW::new(self, 3)
  }
  #[doc = "Bit 8 - NSS Rising Interrupt Enable"]
  #[inline(always)]
  pub fn nssr(&mut self) -> NssrW<'_, IerSpec> {
    NssrW::new(self, 8)
  }
  ...
  #[inline(always)]
  pub fn undes(&mut self) -> UndesW<'_, IerSpec> {
    UndesW::new(self, 10)
  }
}
