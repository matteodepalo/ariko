...
impl W {
  #[doc = "Bits 0:1 - DMA Write Buffer Offset"]
  #[inline(always)]
  pub fn offset(&mut self) -> OffsetW<'_, DmaSpec> {
    OffsetW::new(self, 0)
  }
  #[doc = "Bit 4 - DMA Channel Read and Write Chunk Size"]
  #[inline(always)]
  pub fn chksize(&mut self) -> ChksizeW<'_, DmaSpec> {
    ChksizeW::new(self, 4)
  }
  #[doc = "Bit 8 - DMA Hardware Handshaking Enable"]
  #[inline(always)]
  pub fn dmaen(&mut self) -> DmaenW<'_, DmaSpec> {
    DmaenW::new(self, 8)
  }
  #[doc = "Bit 12 - Read Optimization with padding"]
  #[inline(always)]
  pub fn ropt(&mut self) -> RoptW<'_, DmaSpec> {
    RoptW::new(self, 12)
  }
}
