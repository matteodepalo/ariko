...
impl W {
  ...
  #[inline(always)]
  pub fn cmdnb(&mut self) -> CmdnbW<'_, CmdrSpec> {
    CmdnbW::new(self, 0)
  }
  #[doc = "Bits 6:7 - Response Type"]
  #[inline(always)]
  pub fn rsptyp(&mut self) -> RsptypW<'_, CmdrSpec> {
    RsptypW::new(self, 6)
  }
  #[doc = "Bits 8:10 - Special Command"]
  #[inline(always)]
  pub fn spcmd(&mut self) -> SpcmdW<'_, CmdrSpec> {
    SpcmdW::new(self, 8)
  }
  #[doc = "Bit 11 - Open Drain Command"]
  #[inline(always)]
  pub fn opdcmd(&mut self) -> OpdcmdW<'_, CmdrSpec> {
    OpdcmdW::new(self, 11)
  }
  #[doc = "Bit 12 - Max Latency for Command to Response"]
  #[inline(always)]
  pub fn maxlat(&mut self) -> MaxlatW<'_, CmdrSpec> {
    MaxlatW::new(self, 12)
  }
  #[doc = "Bits 16:17 - Transfer Command"]
  #[inline(always)]
  pub fn trcmd(&mut self) -> TrcmdW<'_, CmdrSpec> {
    TrcmdW::new(self, 16)
  }
  #[doc = "Bit 18 - Transfer Direction"]
  #[inline(always)]
  pub fn trdir(&mut self) -> TrdirW<'_, CmdrSpec> {
    TrdirW::new(self, 18)
  }
  #[doc = "Bits 19:21 - Transfer Type"]
  #[inline(always)]
  pub fn trtyp(&mut self) -> TrtypW<'_, CmdrSpec> {
    TrtypW::new(self, 19)
  }
  #[doc = "Bits 24:25 - SDIO Special Command"]
  #[inline(always)]
  pub fn iospcmd(&mut self) -> IospcmdW<'_, CmdrSpec> {
    IospcmdW::new(self, 24)
  }
  #[doc = "Bit 26 - ATA with Command Completion Signal"]
  #[inline(always)]
  pub fn atacs(&mut self) -> AtacsW<'_, CmdrSpec> {
    AtacsW::new(self, 26)
  }
  #[doc = "Bit 27 - Boot Operation Acknowledge."]
  #[inline(always)]
  pub fn boot_ack(&mut self) -> BootAckW<'_, CmdrSpec> {
