...
impl W {
  #[doc = "Bit 0 - HSMCI Internal FIFO control mode"]
  #[inline(always)]
  pub fn fifomode(&mut self) -> FifomodeW<'_, CfgSpec> {
    FifomodeW::new(self, 0)
  }
  #[doc = "Bit 4 - Flow Error flag reset control mode"]
  #[inline(always)]
  pub fn ferrctrl(&mut self) -> FerrctrlW<'_, CfgSpec> {
    FerrctrlW::new(self, 4)
  }
  #[doc = "Bit 8 - High Speed Mode"]
  #[inline(always)]
  pub fn hsmode(&mut self) -> HsmodeW<'_, CfgSpec> {
    HsmodeW::new(self, 8)
  }
  #[doc = "Bit 12 - Synchronize on the last block"]
  #[inline(always)]
  pub fn lsync(&mut self) -> LsyncW<'_, CfgSpec> {
    LsyncW::new(self, 12)
  }
}
