...
impl W {
  #[doc = "Bits 0:15"]
  #[inline(always)]
  pub fn data(&mut self) -> DataW<'_, ManSpec> {
    DataW::new(self, 0)
  }
  #[doc = "Bits 16:17"]
  #[inline(always)]
  pub fn code(&mut self) -> CodeW<'_, ManSpec> {
    CodeW::new(self, 16)
  }
  #[doc = "Bits 18:22 - Register Address"]
  #[inline(always)]
  pub fn rega(&mut self) -> RegaW<'_, ManSpec> {
    RegaW::new(self, 18)
  }
  #[doc = "Bits 23:27 - PHY Address"]
  #[inline(always)]
  pub fn phya(&mut self) -> PhyaW<'_, ManSpec> {
    PhyaW::new(self, 23)
  }
  #[doc = "Bits 28:29 - Read-write"]
  #[inline(always)]
  pub fn rw(&mut self) -> RwW<'_, ManSpec> {
    RwW::new(self, 28)
  }
  #[doc = "Bits 30:31 - Start of frame"]
  #[inline(always)]
  pub fn sof(&mut self) -> SofW<'_, ManSpec> {
    SofW::new(self, 30)
  }
}
