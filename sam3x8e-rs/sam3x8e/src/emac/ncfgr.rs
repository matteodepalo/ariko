...
impl W {
  #[doc = "Bit 0 - Speed"]
  #[inline(always)]
  pub fn spd(&mut self) -> SpdW<'_, NcfgrSpec> {
    SpdW::new(self, 0)
  }
  #[doc = "Bit 1 - Full Duplex"]
  #[inline(always)]
  pub fn fd(&mut self) -> FdW<'_, NcfgrSpec> {
    FdW::new(self, 1)
  }
  #[doc = "Bit 3 - Jumbo Frames"]
  #[inline(always)]
  pub fn jframe(&mut self) -> JframeW<'_, NcfgrSpec> {
    JframeW::new(self, 3)
  }
  #[doc = "Bit 4 - Copy All Frames"]
  #[inline(always)]
  pub fn caf(&mut self) -> CafW<'_, NcfgrSpec> {
    CafW::new(self, 4)
  }
  #[doc = "Bit 5 - No Broadcast"]
  #[inline(always)]
  pub fn nbc(&mut self) -> NbcW<'_, NcfgrSpec> {
    NbcW::new(self, 5)
  }
  #[doc = "Bit 6 - Multicast Hash Enable"]
  #[inline(always)]
  pub fn mti(&mut self) -> MtiW<'_, NcfgrSpec> {
    MtiW::new(self, 6)
  }
  #[doc = "Bit 7 - Unicast Hash Enable"]
  #[inline(always)]
  pub fn uni(&mut self) -> UniW<'_, NcfgrSpec> {
    UniW::new(self, 7)
  }
  #[doc = "Bit 8 - Receive 1536 bytes frames"]
  #[inline(always)]
  pub fn big(&mut self) -> BigW<'_, NcfgrSpec> {
    BigW::new(self, 8)
  }
  #[doc = "Bits 10:11 - MDC clock divider"]
  #[inline(always)]
  pub fn clk(&mut self) -> ClkW<'_, NcfgrSpec> {
    ClkW::new(self, 10)
  }
  #[doc = "Bit 12 - Retry test"]
  #[inline(always)]
  pub fn rty(&mut self) -> RtyW<'_, NcfgrSpec> {
    RtyW::new(self, 12)
  }
  #[doc = "Bit 13 - Pause Enable"]
  #[inline(always)]
  pub fn pae(&mut self) -> PaeW<'_, NcfgrSpec> {
    PaeW::new(self, 13)
  }
  #[doc = "Bits 14:15 - Receive Buffer Offset"]
  #[inline(always)]
  pub fn rbof(&mut self) -> RbofW<'_, NcfgrSpec> {
    RbofW::new(self, 14)
  }
  #[doc = "Bit 16 - Receive Length field Checking Enable"]
  #[inline(always)]
  pub fn rlce(&mut self) -> RlceW<'_, NcfgrSpec> {
    RlceW::new(self, 16)
  }
  #[doc = "Bit 17 - Discard Receive FCS"]
  #[inline(always)]
  pub fn drfcs(&mut self) -> DrfcsW<'_, NcfgrSpec> {
    DrfcsW::new(self, 17)
  }
  #[doc = "Bit 18"]
  #[inline(always)]
  pub fn efrhd(&mut self) -> EfrhdW<'_, NcfgrSpec> {
    EfrhdW::new(self, 18)
  }
  #[doc = "Bit 19 - Ignore RX FCS"]
  #[inline(always)]
  pub fn irxfcs(&mut self) -> IrxfcsW<'_, NcfgrSpec> {
    IrxfcsW::new(self, 19)
  }
}
