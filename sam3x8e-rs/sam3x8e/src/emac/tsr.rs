...
impl W {
  #[doc = "Bit 0 - Used Bit Read"]
  #[inline(always)]
  pub fn ubr(&mut self) -> UbrW<'_, TsrSpec> {
    UbrW::new(self, 0)
  }
  #[doc = "Bit 1 - Collision Occurred"]
  #[inline(always)]
  pub fn col(&mut self) -> ColW<'_, TsrSpec> {
    ColW::new(self, 1)
  }
  #[doc = "Bit 2 - Retry Limit exceeded"]
  #[inline(always)]
  pub fn rles(&mut self) -> RlesW<'_, TsrSpec> {
    RlesW::new(self, 2)
  }
  #[doc = "Bit 3 - Transmit Go"]
  #[inline(always)]
  pub fn tgo(&mut self) -> TgoW<'_, TsrSpec> {
    TgoW::new(self, 3)
  }
  #[doc = "Bit 4 - Buffers exhausted mid frame"]
  #[inline(always)]
  pub fn bex(&mut self) -> BexW<'_, TsrSpec> {
    BexW::new(self, 4)
  }
  #[doc = "Bit 5 - Transmit Complete"]
  #[inline(always)]
  pub fn comp(&mut self) -> CompW<'_, TsrSpec> {
    CompW::new(self, 5)
  }
  #[doc = "Bit 6 - Transmit Underrun"]
  #[inline(always)]
  pub fn und(&mut self) -> UndW<'_, TsrSpec> {
    UndW::new(self, 6)
  }
}
