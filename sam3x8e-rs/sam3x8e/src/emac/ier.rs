...
impl W {
  ...
  #[inline(always)]
  pub fn mfd(&mut self) -> MfdW<'_, IerSpec> {
    MfdW::new(self, 0)
  }
  #[doc = "Bit 1 - Receive Complete"]
  #[inline(always)]
  pub fn rcomp(&mut self) -> RcompW<'_, IerSpec> {
    RcompW::new(self, 1)
  }
  #[doc = "Bit 2 - Receive Used Bit Read"]
  #[inline(always)]
  pub fn rxubr(&mut self) -> RxubrW<'_, IerSpec> {
    RxubrW::new(self, 2)
  }
  #[doc = "Bit 3 - Transmit Used Bit Read"]
  #[inline(always)]
  pub fn txubr(&mut self) -> TxubrW<'_, IerSpec> {
    TxubrW::new(self, 3)
  }
  #[doc = "Bit 4 - Ethernet Transmit Buffer Underrun"]
  #[inline(always)]
  pub fn tund(&mut self) -> TundW<'_, IerSpec> {
    TundW::new(self, 4)
  }
  #[doc = "Bit 5 - Retry Limit Exceeded"]
  #[inline(always)]
  pub fn rle(&mut self) -> RleW<'_, IerSpec> {
    RleW::new(self, 5)
  }
  #[doc = "Bit 6"]
  #[inline(always)]
  pub fn txerr(&mut self) -> TxerrW<'_, IerSpec> {
    TxerrW::new(self, 6)
  }
  #[doc = "Bit 7 - Transmit Complete"]
  #[inline(always)]
  pub fn tcomp(&mut self) -> TcompW<'_, IerSpec> {
    TcompW::new(self, 7)
  }
  #[doc = "Bit 10 - Receive Overrun"]
  #[inline(always)]
  pub fn rovr(&mut self) -> RovrW<'_, IerSpec> {
    RovrW::new(self, 10)
  }
  #[doc = "Bit 11 - Hresp not OK"]
  #[inline(always)]
  pub fn hresp(&mut self) -> HrespW<'_, IerSpec> {
    HrespW::new(self, 11)
  }
  #[doc = "Bit 12 - Pause Frame Received"]
  #[inline(always)]
  pub fn pfr(&mut self) -> PfrW<'_, IerSpec> {
    PfrW::new(self, 12)
  }
  #[doc = "Bit 13 - Pause Time Zero"]
  #[inline(always)]
  pub fn ptz(&mut self) -> PtzW<'_, IerSpec> {
    PtzW::new(self, 13)
  }
}
