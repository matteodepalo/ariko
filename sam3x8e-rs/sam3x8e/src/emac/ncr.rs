...
impl W {
  #[doc = "Bit 0 - LoopBack"]
  #[inline(always)]
  pub fn lb(&mut self) -> LbW<'_, NcrSpec> {
    LbW::new(self, 0)
  }
  #[doc = "Bit 1 - Loopback local"]
  #[inline(always)]
  pub fn llb(&mut self) -> LlbW<'_, NcrSpec> {
    LlbW::new(self, 1)
  }
  #[doc = "Bit 2 - Receive enable"]
  #[inline(always)]
  pub fn re(&mut self) -> ReW<'_, NcrSpec> {
    ReW::new(self, 2)
  }
  #[doc = "Bit 3 - Transmit enable"]
  #[inline(always)]
  pub fn te(&mut self) -> TeW<'_, NcrSpec> {
    TeW::new(self, 3)
  }
  #[doc = "Bit 4 - Management port enable"]
  #[inline(always)]
  pub fn mpe(&mut self) -> MpeW<'_, NcrSpec> {
    MpeW::new(self, 4)
  }
  #[doc = "Bit 5 - Clear statistics registers"]
  #[inline(always)]
  pub fn clrstat(&mut self) -> ClrstatW<'_, NcrSpec> {
    ClrstatW::new(self, 5)
  }
  #[doc = "Bit 6 - Increment statistics registers"]
  #[inline(always)]
  pub fn incstat(&mut self) -> IncstatW<'_, NcrSpec> {
    IncstatW::new(self, 6)
  }
  #[doc = "Bit 7 - Write enable for statistics registers"]
  #[inline(always)]
  pub fn westat(&mut self) -> WestatW<'_, NcrSpec> {
    WestatW::new(self, 7)
  }
  #[doc = "Bit 8 - Back pressure"]
  #[inline(always)]
  pub fn bp(&mut self) -> BpW<'_, NcrSpec> {
    BpW::new(self, 8)
  }
  #[doc = "Bit 9 - Start transmission"]
  #[inline(always)]
  pub fn tstart(&mut self) -> TstartW<'_, NcrSpec> {
    TstartW::new(self, 9)
  }
  #[doc = "Bit 10 - Transmit halt"]
  #[inline(always)]
  pub fn thalt(&mut self) -> ThaltW<'_, NcrSpec> {
    ThaltW::new(self, 10)
  }
}
