...
impl W {
  ...
  #[doc = "Bit 4 - Word Transfer"]
  #[inline(always)]
  pub fn word(&mut self) -> WordW<'_, MrSpec> {
    WordW::new(self, 4)
  }
  #[doc = "Bit 5 - Sleep Mode"]
  #[inline(always)]
  ...
  #[doc = "Bit 6 - Fast Wake up Mode"]
  #[inline(always)]
  pub fn fastwkup(&mut self) -> FastwkupW<'_, MrSpec> {
    FastwkupW::new(self, 6)
  }
  #[doc = "Bits 8:15 - Refresh Period"]
  #[inline(always)]
  pub fn refresh(&mut self) -> RefreshW<'_, MrSpec> {
    RefreshW::new(self, 8)
  }
  #[doc = "Bits 16:17 - User Channel Selection"]
  #[inline(always)]
  pub fn user_sel(&mut self) -> UserSelW<'_, MrSpec> {
    UserSelW::new(self, 16)
  }
  #[doc = "Bit 20 - Tag Selection Mode"]
  #[inline(always)]
  pub fn tag(&mut self) -> TagW<'_, MrSpec> {
    TagW::new(self, 20)
  }
  #[doc = "Bit 21 - Max Speed Mode"]
  #[inline(always)]
  pub fn maxs(&mut self) -> MaxsW<'_, MrSpec> {
    MaxsW::new(self, 21)
  }
  #[doc = "Bits 24:29 - Startup Time Selection"]
  #[inline(always)]
