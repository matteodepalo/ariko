...
impl W {
  ...
  #[inline(always)]
  pub fn endtx(&mut self) -> EndtxW<'_, IerSpec> {
    EndtxW::new(self, 4)
  }
  ...
  #[inline(always)]
  pub fn nack(&mut self) -> NackW<'_, IerSpec> {
    NackW::new(self, 13)
  }
  #[doc = "Bit 19 - Clear to Send Input Change Interrupt Enable"]
  #[inline(always)]
  pub fn ctsic(&mut self) -> CtsicW<'_, IerSpec> {
    CtsicW::new(self, 19)
  }
  #[doc = "Bit 24 - Manchester Error Interrupt Enable"]
  #[inline(always)]
  pub fn mane(&mut self) -> ManeW<'_, IerSpec> {
    ManeW::new(self, 24)
  }
}
