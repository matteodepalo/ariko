...
impl W {
  ...
  #[inline(always)]
  pub fn pid32(&mut self) -> Pid32W<'_, PmcPcer1Spec> {
    Pid32W::new(self, 0)
  }
  #[doc = "Bit 1 - Peripheral Clock 33 Enable"]
  #[inline(always)]
  pub fn pid33(&mut self) -> Pid33W<'_, PmcPcer1Spec> {
    Pid33W::new(self, 1)
  }
  #[doc = "Bit 2 - Peripheral Clock 34 Enable"]
  #[inline(always)]
  pub fn pid34(&mut self) -> Pid34W<'_, PmcPcer1Spec> {
    Pid34W::new(self, 2)
  }
  #[doc = "Bit 3 - Peripheral Clock 35 Enable"]
  #[inline(always)]
  pub fn pid35(&mut self) -> Pid35W<'_, PmcPcer1Spec> {
    Pid35W::new(self, 3)
  }
  #[doc = "Bit 4 - Peripheral Clock 36 Enable"]
  #[inline(always)]
  pub fn pid36(&mut self) -> Pid36W<'_, PmcPcer1Spec> {
    Pid36W::new(self, 4)
  }
  #[doc = "Bit 5 - Peripheral Clock 37 Enable"]
  #[inline(always)]
  pub fn pid37(&mut self) -> Pid37W<'_, PmcPcer1Spec> {
    Pid37W::new(self, 5)
  }
  #[doc = "Bit 6 - Peripheral Clock 38 Enable"]
  #[inline(always)]
  pub fn pid38(&mut self) -> Pid38W<'_, PmcPcer1Spec> {
    Pid38W::new(self, 6)
  }
  #[doc = "Bit 7 - Peripheral Clock 39 Enable"]
  #[inline(always)]
  pub fn pid39(&mut self) -> Pid39W<'_, PmcPcer1Spec> {
    Pid39W::new(self, 7)
  }
  #[doc = "Bit 8 - Peripheral Clock 40 Enable"]
  #[inline(always)]
  pub fn pid40(&mut self) -> Pid40W<'_, PmcPcer1Spec> {
    Pid40W::new(self, 8)
  }
  #[doc = "Bit 9 - Peripheral Clock 41 Enable"]
  #[inline(always)]
  pub fn pid41(&mut self) -> Pid41W<'_, PmcPcer1Spec> {
    Pid41W::new(self, 9)
  }
  #[doc = "Bit 10 - Peripheral Clock 42 Enable"]
  #[inline(always)]
  pub fn pid42(&mut self) -> Pid42W<'_, PmcPcer1Spec> {
    Pid42W::new(self, 10)
  }
  #[doc = "Bit 11 - Peripheral Clock 43 Enable"]
  #[inline(always)]
  pub fn pid43(&mut self) -> Pid43W<'_, PmcPcer1Spec> {
    Pid43W::new(self, 11)
  }
  #[doc = "Bit 12 - Peripheral Clock 44 Enable"]
  #[inline(always)]
  pub fn pid44(&mut self) -> Pid44W<'_, PmcPcer1Spec> {
    Pid44W::new(self, 12)
  }
}
