...
impl W {
  #[doc = "Bits 0:1 - Master Clock Source Selection"]
  #[inline(always)]
  pub fn css(&mut self) -> CssW<'_, PmcMckrSpec> {
    CssW::new(self, 0)
  }
  #[doc = "Bits 4:6 - Processor Clock Prescaler"]
  #[inline(always)]
  pub fn pres(&mut self) -> PresW<'_, PmcMckrSpec> {
    PresW::new(self, 4)
  }
  #[doc = "Bit 12 - PLLA Divisor by 2"]
  #[inline(always)]
  pub fn plladiv2(&mut self) -> Plladiv2W<'_, PmcMckrSpec> {
    Plladiv2W::new(self, 12)
  }
  #[doc = "Bit 13"]
  #[inline(always)]
  pub fn uplldiv2(&mut self) -> Uplldiv2W<'_, PmcMckrSpec> {
