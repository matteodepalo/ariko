...
impl W {
  #[doc = "Bit 0 - Main Crystal Oscillator Enable"]
  #[inline(always)]
  pub fn moscxten(&mut self) -> MoscxtenW<'_, CkgrMorSpec> {
    MoscxtenW::new(self, 0)
  }
  #[doc = "Bit 1 - Main Crystal Oscillator Bypass"]
  #[inline(always)]
  pub fn moscxtby(&mut self) -> MoscxtbyW<'_, CkgrMorSpec> {
    MoscxtbyW::new(self, 1)
  }
  #[doc = "Bit 3 - Main On-Chip RC Oscillator Enable"]
  #[inline(always)]
  pub fn moscrcen(&mut self) -> MoscrcenW<'_, CkgrMorSpec> {
    MoscrcenW::new(self, 3)
  }
  #[doc = "Bits 4:6 - Main On-Chip RC Oscillator Frequency Selection"]
  #[inline(always)]
  pub fn moscrcf(&mut self) -> MoscrcfW<'_, CkgrMorSpec> {
    MoscrcfW::new(self, 4)
  }
  #[doc = "Bits 8:15 - Main Crystal Oscillator Start-up Time"]
  #[inline(always)]
  pub fn moscxtst(&mut self) -> MoscxtstW<'_, CkgrMorSpec> {
    MoscxtstW::new(self, 8)
  }
  #[doc = "Bits 16:23 - Password"]
  #[inline(always)]
  pub fn key(&mut self) -> KeyW<'_, CkgrMorSpec> {
    KeyW::new(self, 16)
  }
  #[doc = "Bit 24 - Main Oscillator Selection"]
  #[inline(always)]
  pub fn moscsel(&mut self) -> MoscselW<'_, CkgrMorSpec> {
    MoscselW::new(self, 24)
  }
  #[doc = "Bit 25 - Clock Failure Detector Enable"]
  #[inline(always)]
  pub fn cfden(&mut self) -> CfdenW<'_, CkgrMorSpec> {
    CfdenW::new(self, 25)
  }
}
