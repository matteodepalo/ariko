...
impl W {
  #[doc = "Bit 0 - Offset for channel 0"]
  #[inline(always)]
  pub fn off0(&mut self) -> Off0W<'_, CorSpec> {
    Off0W::new(self, 0)
  }
  #[doc = "Bit 1 - Offset for channel 1"]
  #[inline(always)]
  pub fn off1(&mut self) -> Off1W<'_, CorSpec> {
    Off1W::new(self, 1)
  }
  #[doc = "Bit 2 - Offset for channel 2"]
  #[inline(always)]
  pub fn off2(&mut self) -> Off2W<'_, CorSpec> {
    Off2W::new(self, 2)
  }
  #[doc = "Bit 3 - Offset for channel 3"]
  #[inline(always)]
  pub fn off3(&mut self) -> Off3W<'_, CorSpec> {
    Off3W::new(self, 3)
  }
  #[doc = "Bit 4 - Offset for channel 4"]
  #[inline(always)]
  pub fn off4(&mut self) -> Off4W<'_, CorSpec> {
    Off4W::new(self, 4)
  }
  #[doc = "Bit 5 - Offset for channel 5"]
  #[inline(always)]
  pub fn off5(&mut self) -> Off5W<'_, CorSpec> {
    Off5W::new(self, 5)
  }
  #[doc = "Bit 6 - Offset for channel 6"]
  #[inline(always)]
  pub fn off6(&mut self) -> Off6W<'_, CorSpec> {
    Off6W::new(self, 6)
  }
  #[doc = "Bit 7 - Offset for channel 7"]
  #[inline(always)]
  pub fn off7(&mut self) -> Off7W<'_, CorSpec> {
    Off7W::new(self, 7)
  }
  #[doc = "Bit 8 - Offset for channel 8"]
  #[inline(always)]
  pub fn off8(&mut self) -> Off8W<'_, CorSpec> {
    Off8W::new(self, 8)
  }
  #[doc = "Bit 9 - Offset for channel 9"]
  #[inline(always)]
  pub fn off9(&mut self) -> Off9W<'_, CorSpec> {
    Off9W::new(self, 9)
  }
  #[doc = "Bit 10 - Offset for channel 10"]
  #[inline(always)]
  pub fn off10(&mut self) -> Off10W<'_, CorSpec> {
    Off10W::new(self, 10)
  }
  #[doc = "Bit 11 - Offset for channel 11"]
  #[inline(always)]
  pub fn off11(&mut self) -> Off11W<'_, CorSpec> {
    Off11W::new(self, 11)
  }
  #[doc = "Bit 12 - Offset for channel 12"]
  #[inline(always)]
  pub fn off12(&mut self) -> Off12W<'_, CorSpec> {
    Off12W::new(self, 12)
  }
  #[doc = "Bit 13 - Offset for channel 13"]
  #[inline(always)]
  pub fn off13(&mut self) -> Off13W<'_, CorSpec> {
    Off13W::new(self, 13)
  }
  #[doc = "Bit 14 - Offset for channel 14"]
  #[inline(always)]
  pub fn off14(&mut self) -> Off14W<'_, CorSpec> {
    Off14W::new(self, 14)
  }
  #[doc = "Bit 15 - Offset for channel 15"]
  #[inline(always)]
  pub fn off15(&mut self) -> Off15W<'_, CorSpec> {
    Off15W::new(self, 15)
  }
  #[doc = "Bit 16 - Differential inputs for channel 0"]
  #[inline(always)]
  pub fn diff0(&mut self) -> Diff0W<'_, CorSpec> {
    Diff0W::new(self, 16)
  }
  #[doc = "Bit 17 - Differential inputs for channel 1"]
  #[inline(always)]
  pub fn diff1(&mut self) -> Diff1W<'_, CorSpec> {
    Diff1W::new(self, 17)
  }
  #[doc = "Bit 18 - Differential inputs for channel 2"]
  #[inline(always)]
  pub fn diff2(&mut self) -> Diff2W<'_, CorSpec> {
    Diff2W::new(self, 18)
  }
  #[doc = "Bit 19 - Differential inputs for channel 3"]
  #[inline(always)]
  pub fn diff3(&mut self) -> Diff3W<'_, CorSpec> {
    Diff3W::new(self, 19)
  }
  #[doc = "Bit 20 - Differential inputs for channel 4"]
  #[inline(always)]
  pub fn diff4(&mut self) -> Diff4W<'_, CorSpec> {
    Diff4W::new(self, 20)
  }
  #[doc = "Bit 21 - Differential inputs for channel 5"]
  #[inline(always)]
  pub fn diff5(&mut self) -> Diff5W<'_, CorSpec> {
    Diff5W::new(self, 21)
  }
  #[doc = "Bit 22 - Differential inputs for channel 6"]
  #[inline(always)]
  pub fn diff6(&mut self) -> Diff6W<'_, CorSpec> {
    Diff6W::new(self, 22)
  }
  #[doc = "Bit 23 - Differential inputs for channel 7"]
  #[inline(always)]
  pub fn diff7(&mut self) -> Diff7W<'_, CorSpec> {
    Diff7W::new(self, 23)
  }
  #[doc = "Bit 24 - Differential inputs for channel 8"]
  #[inline(always)]
  pub fn diff8(&mut self) -> Diff8W<'_, CorSpec> {
    Diff8W::new(self, 24)
  }
  #[doc = "Bit 25 - Differential inputs for channel 9"]
  #[inline(always)]
  pub fn diff9(&mut self) -> Diff9W<'_, CorSpec> {
    Diff9W::new(self, 25)
  }
  #[doc = "Bit 26 - Differential inputs for channel 10"]
  #[inline(always)]
  pub fn diff10(&mut self) -> Diff10W<'_, CorSpec> {
    Diff10W::new(self, 26)
  }
  #[doc = "Bit 27 - Differential inputs for channel 11"]
  #[inline(always)]
  pub fn diff11(&mut self) -> Diff11W<'_, CorSpec> {
    Diff11W::new(self, 27)
  }
  #[doc = "Bit 28 - Differential inputs for channel 12"]
  #[inline(always)]
  pub fn diff12(&mut self) -> Diff12W<'_, CorSpec> {
    Diff12W::new(self, 28)
  }
  #[doc = "Bit 29 - Differential inputs for channel 13"]
  #[inline(always)]
  pub fn diff13(&mut self) -> Diff13W<'_, CorSpec> {
    Diff13W::new(self, 29)
  }
  #[doc = "Bit 30 - Differential inputs for channel 14"]
  #[inline(always)]
  pub fn diff14(&mut self) -> Diff14W<'_, CorSpec> {
    Diff14W::new(self, 30)
  }
  #[doc = "Bit 31 - Differential inputs for channel 15"]
  #[inline(always)]
  pub fn diff15(&mut self) -> Diff15W<'_, CorSpec> {
    Diff15W::new(self, 31)
  }
}
