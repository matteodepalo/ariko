...
pub type W = crate::W<DeveptierSpec>;
...
impl W {
  ...
  #[inline(always)]
  pub fn txines(&mut self) -> TxinesW<'_, DeveptierSpec> {
    TxinesW::new(self, 0)
  }
  #[doc = "Bit 1 - Received OUT Data Interrupt Enable"]
  #[inline(always)]
  pub fn rxoutes(&mut self) -> RxoutesW<'_, DeveptierSpec> {
    RxoutesW::new(self, 1)
  }
  #[doc = "Bit 2 - Received SETUP Interrupt Enable"]
  #[inline(always)]
  pub fn rxstpes(&mut self) -> RxstpesW<'_, DeveptierSpec> {
    RxstpesW::new(self, 2)
  }
  #[doc = "Bit 3 - NAKed OUT Interrupt Enable"]
  #[inline(always)]
  pub fn nakoutes(&mut self) -> NakoutesW<'_, DeveptierSpec> {
    NakoutesW::new(self, 3)
  }
  #[doc = "Bit 4 - NAKed IN Interrupt Enable"]
  #[inline(always)]
  pub fn nakines(&mut self) -> NakinesW<'_, DeveptierSpec> {
    NakinesW::new(self, 4)
  }
  #[doc = "Bit 5 - Overflow Interrupt Enable"]
  #[inline(always)]
  pub fn overfes(&mut self) -> OverfesW<'_, DeveptierSpec> {
    OverfesW::new(self, 5)
  }
  #[doc = "Bit 6 - STALLed Interrupt Enable"]
  #[inline(always)]
  pub fn stalledes(&mut self) -> StalledesW<'_, DeveptierSpec> {
    StalledesW::new(self, 6)
  }
  #[doc = "Bit 7 - Short Packet Interrupt Enable"]
  #[inline(always)]
  pub fn shortpacketes(&mut self) -> ShortpacketesW<'_, DeveptierSpec> {
    ShortpacketesW::new(self, 7)
  }
  #[doc = "Bit 12 - Number of Busy Banks Interrupt Enable"]
  #[inline(always)]
  pub fn nbusybkes(&mut self) -> NbusybkesW<'_, DeveptierSpec> {
    NbusybkesW::new(self, 12)
  }
  #[doc = "Bit 13 - Kill IN Bank"]
  #[inline(always)]
  pub fn killbks(&mut self) -> KillbksW<'_, DeveptierSpec> {
    KillbksW::new(self, 13)
  }
  #[doc = "Bit 14 - FIFO Control"]
  #[inline(always)]
  pub fn fifocons(&mut self) -> FifoconsW<'_, DeveptierSpec> {
    FifoconsW::new(self, 14)
  }
  #[doc = "Bit 16 - Endpoint Interrupts Disable HDMA Request Enable"]
  #[inline(always)]
  pub fn epdishdmas(&mut self) -> EpdishdmasW<'_, DeveptierSpec> {
    EpdishdmasW::new(self, 16)
  }
  #[doc = "Bit 17 - NYET Token Disable Enable"]
  #[inline(always)]
  pub fn nyetdiss(&mut self) -> NyetdissW<'_, DeveptierSpec> {
    NyetdissW::new(self, 17)
  }
  #[doc = "Bit 18 - Reset Data Toggle Enable"]
  #[inline(always)]
  pub fn rstdts(&mut self) -> RstdtsW<'_, DeveptierSpec> {
    RstdtsW::new(self, 18)
  }
  #[doc = "Bit 19 - STALL Request Enable"]
  #[inline(always)]
  pub fn stallrqs(&mut self) -> StallrqsW<'_, DeveptierSpec> {
    StallrqsW::new(self, 19)
  }
}
#[doc = "Device Endpoint Enable Register (n = 0)\n\nYou can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`deveptier::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DeveptierSpec;
impl crate::RegisterSpec for DeveptierSpec {
  type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`deveptier::W`](W) writer structure"]
impl crate::Writable for DeveptierSpec {
