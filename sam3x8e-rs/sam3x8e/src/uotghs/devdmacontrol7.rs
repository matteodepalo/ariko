...
impl W {
  #[doc = "Bit 0 - Channel Enable Command"]
  #[inline(always)]
  pub fn chann_enb(&mut self) -> ChannEnbW<'_, Devdmacontrol7Spec> {
    ChannEnbW::new(self, 0)
  }
  #[doc = "Bit 1 - Load Next Channel Transfer Descriptor Enable Command"]
  #[inline(always)]
  pub fn ldnxt_dsc(&mut self) -> LdnxtDscW<'_, Devdmacontrol7Spec> {
    LdnxtDscW::new(self, 1)
  }
  #[doc = "Bit 2 - End of Transfer Enable Control"]
  #[inline(always)]
  pub fn end_tr_en(&mut self) -> EndTrEnW<'_, Devdmacontrol7Spec> {
    EndTrEnW::new(self, 2)
  }
  #[doc = "Bit 3 - End of Buffer Enable Control"]
  #[inline(always)]
  pub fn end_b_en(&mut self) -> EndBEnW<'_, Devdmacontrol7Spec> {
    EndBEnW::new(self, 3)
  }
  #[doc = "Bit 4 - End of Transfer Interrupt Enable"]
  #[inline(always)]
  pub fn end_tr_it(&mut self) -> EndTrItW<'_, Devdmacontrol7Spec> {
    EndTrItW::new(self, 4)
  }
  #[doc = "Bit 5 - End of Buffer Interrupt Enable"]
  #[inline(always)]
  pub fn end_buffit(&mut self) -> EndBuffitW<'_, Devdmacontrol7Spec> {
    EndBuffitW::new(self, 5)
  }
  #[doc = "Bit 6 - Descriptor Loaded Interrupt Enable"]
  #[inline(always)]
  pub fn desc_ld_it(&mut self) -> DescLdItW<'_, Devdmacontrol7Spec> {
    DescLdItW::new(self, 6)
  }
  #[doc = "Bit 7 - Burst Lock Enable"]
  #[inline(always)]
  pub fn burst_lck(&mut self) -> BurstLckW<'_, Devdmacontrol7Spec> {
    BurstLckW::new(self, 7)
  }
  #[doc = "Bits 16:31 - Buffer Byte Length (Write-only)"]
  #[inline(always)]
  pub fn buff_length(&mut self) -> BuffLengthW<'_, Devdmacontrol7Spec> {
