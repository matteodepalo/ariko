...
impl W {
  #[doc = "Bit 8 - Start of Frame Generation Enable"]
  #[inline(always)]
  pub fn sofe(&mut self) -> SofeW<'_, HstctrlSpec> {
    SofeW::new(self, 8)
  }
  #[doc = "Bit 9 - Send USB Reset"]
  #[inline(always)]
  pub fn reset(&mut self) -> ResetW<'_, HstctrlSpec> {
    ResetW::new(self, 9)
  }
  #[doc = "Bit 10 - Send USB Resume"]
  #[inline(always)]
  pub fn resume(&mut self) -> ResumeW<'_, HstctrlSpec> {
    ResumeW::new(self, 10)
  }
  #[doc = "Bits 12:13 - Mode Configuration"]
  #[inline(always)]
  pub fn spdconf(&mut self) -> SpdconfW<'_, HstctrlSpec> {
