...
impl W {
  ...
  #[inline(always)]
  pub fn susps(&mut self) -> SuspsW<'_, DevifrSpec> {
    SuspsW::new(self, 0)
  }
  #[doc = "Bit 1 - Micro Start of Frame Interrupt Set"]
  #[inline(always)]
  pub fn msofs(&mut self) -> MsofsW<'_, DevifrSpec> {
    MsofsW::new(self, 1)
  }
  #[doc = "Bit 2 - Start of Frame Interrupt Set"]
  #[inline(always)]
  pub fn sofs(&mut self) -> SofsW<'_, DevifrSpec> {
    SofsW::new(self, 2)
  }
  #[doc = "Bit 3 - End of Reset Interrupt Set"]
  #[inline(always)]
  pub fn eorsts(&mut self) -> EorstsW<'_, DevifrSpec> {
    EorstsW::new(self, 3)
  }
  #[doc = "Bit 4 - Wake-Up Interrupt Set"]
  #[inline(always)]
  pub fn wakeups(&mut self) -> WakeupsW<'_, DevifrSpec> {
    WakeupsW::new(self, 4)
  }
  #[doc = "Bit 5 - End of Resume Interrupt Set"]
  #[inline(always)]
  pub fn eorsms(&mut self) -> EorsmsW<'_, DevifrSpec> {
    EorsmsW::new(self, 5)
  }
  #[doc = "Bit 6 - Upstream Resume Interrupt Set"]
  #[inline(always)]
  pub fn uprsms(&mut self) -> UprsmsW<'_, DevifrSpec> {
    UprsmsW::new(self, 6)
  }
  #[doc = "Bit 25 - DMA Channel 1 Interrupt Set"]
  #[inline(always)]
  pub fn dma_1(&mut self) -> Dma1W<'_, DevifrSpec> {
    Dma1W::new(self, 25)
  }
  #[doc = "Bit 26 - DMA Channel 2 Interrupt Set"]
  #[inline(always)]
  pub fn dma_2(&mut self) -> Dma2W<'_, DevifrSpec> {
    Dma2W::new(self, 26)
  }
  #[doc = "Bit 27 - DMA Channel 3 Interrupt Set"]
  #[inline(always)]
  pub fn dma_3(&mut self) -> Dma3W<'_, DevifrSpec> {
    Dma3W::new(self, 27)
  }
  #[doc = "Bit 28 - DMA Channel 4 Interrupt Set"]
  #[inline(always)]
  pub fn dma_4(&mut self) -> Dma4W<'_, DevifrSpec> {
    Dma4W::new(self, 28)
  }
  #[doc = "Bit 29 - DMA Channel 5 Interrupt Set"]
  #[inline(always)]
  pub fn dma_5(&mut self) -> Dma5W<'_, DevifrSpec> {
    Dma5W::new(self, 29)
  }
  #[doc = "Bit 30 - DMA Channel 6 Interrupt Set"]
  #[inline(always)]
  pub fn dma_6(&mut self) -> Dma6W<'_, DevifrSpec> {
    Dma6W::new(self, 30)
  }
}
