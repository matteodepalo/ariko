...
impl W {
  ...
  #[inline(always)]
  pub fn dconnies(&mut self) -> DconniesW<'_, HstierSpec> {
    DconniesW::new(self, 0)
  }
  #[doc = "Bit 1 - Device Disconnection Interrupt Enable"]
  #[inline(always)]
  pub fn ddiscies(&mut self) -> DdisciesW<'_, HstierSpec> {
    DdisciesW::new(self, 1)
  }
  #[doc = "Bit 2 - USB Reset Sent Interrupt Enable"]
  #[inline(always)]
  pub fn rsties(&mut self) -> RstiesW<'_, HstierSpec> {
    RstiesW::new(self, 2)
  }
  #[doc = "Bit 3 - Downstream Resume Sent Interrupt Enable"]
  #[inline(always)]
  pub fn rsmedies(&mut self) -> RsmediesW<'_, HstierSpec> {
    RsmediesW::new(self, 3)
  }
  #[doc = "Bit 4 - Upstream Resume Received Interrupt Enable"]
  #[inline(always)]
  pub fn rxrsmies(&mut self) -> RxrsmiesW<'_, HstierSpec> {
    RxrsmiesW::new(self, 4)
  }
  #[doc = "Bit 5 - Host Start of Frame Interrupt Enable"]
  #[inline(always)]
  pub fn hsofies(&mut self) -> HsofiesW<'_, HstierSpec> {
    HsofiesW::new(self, 5)
  }
  #[doc = "Bit 6 - Host Wake-Up Interrupt Enable"]
  #[inline(always)]
  pub fn hwupies(&mut self) -> HwupiesW<'_, HstierSpec> {
    HwupiesW::new(self, 6)
  }
  #[doc = "Bit 8 - Pipe 0 Interrupt Enable"]
  #[inline(always)]
  pub fn pep_0(&mut self) -> Pep0W<'_, HstierSpec> {
    Pep0W::new(self, 8)
  }
  #[doc = "Bit 9 - Pipe 1 Interrupt Enable"]
  #[inline(always)]
  pub fn pep_1(&mut self) -> Pep1W<'_, HstierSpec> {
    Pep1W::new(self, 9)
  }
  #[doc = "Bit 10 - Pipe 2 Interrupt Enable"]
  #[inline(always)]
  pub fn pep_2(&mut self) -> Pep2W<'_, HstierSpec> {
    Pep2W::new(self, 10)
  }
  #[doc = "Bit 11 - Pipe 3 Interrupt Enable"]
  #[inline(always)]
  pub fn pep_3(&mut self) -> Pep3W<'_, HstierSpec> {
    Pep3W::new(self, 11)
  }
  #[doc = "Bit 12 - Pipe 4 Interrupt Enable"]
  #[inline(always)]
  pub fn pep_4(&mut self) -> Pep4W<'_, HstierSpec> {
    Pep4W::new(self, 12)
  }
  #[doc = "Bit 13 - Pipe 5 Interrupt Enable"]
  #[inline(always)]
  pub fn pep_5(&mut self) -> Pep5W<'_, HstierSpec> {
    Pep5W::new(self, 13)
  }
  #[doc = "Bit 14 - Pipe 6 Interrupt Enable"]
  #[inline(always)]
  pub fn pep_6(&mut self) -> Pep6W<'_, HstierSpec> {
    Pep6W::new(self, 14)
  }
  #[doc = "Bit 15 - Pipe 7 Interrupt Enable"]
  #[inline(always)]
  pub fn pep_7(&mut self) -> Pep7W<'_, HstierSpec> {
    Pep7W::new(self, 15)
  }
  #[doc = "Bit 16 - Pipe 8 Interrupt Enable"]
  #[inline(always)]
  pub fn pep_8(&mut self) -> Pep8W<'_, HstierSpec> {
    Pep8W::new(self, 16)
  }
  #[doc = "Bit 17 - Pipe 9 Interrupt Enable"]
  #[inline(always)]
  pub fn pep_9(&mut self) -> Pep9W<'_, HstierSpec> {
    Pep9W::new(self, 17)
  }
  #[doc = "Bit 25 - DMA Channel 1 Interrupt Enable"]
  #[inline(always)]
  pub fn dma_1(&mut self) -> Dma1W<'_, HstierSpec> {
    Dma1W::new(self, 25)
  }
  #[doc = "Bit 26 - DMA Channel 2 Interrupt Enable"]
  #[inline(always)]
  pub fn dma_2(&mut self) -> Dma2W<'_, HstierSpec> {
    Dma2W::new(self, 26)
  }
  #[doc = "Bit 27 - DMA Channel 3 Interrupt Enable"]
  #[inline(always)]
  pub fn dma_3(&mut self) -> Dma3W<'_, HstierSpec> {
    Dma3W::new(self, 27)
  }
  #[doc = "Bit 28 - DMA Channel 4 Interrupt Enable"]
  #[inline(always)]
  pub fn dma_4(&mut self) -> Dma4W<'_, HstierSpec> {
    Dma4W::new(self, 28)
  }
  #[doc = "Bit 29 - DMA Channel 5 Interrupt Enable"]
  #[inline(always)]
  pub fn dma_5(&mut self) -> Dma5W<'_, HstierSpec> {
    Dma5W::new(self, 29)
  }
  #[doc = "Bit 30 - DMA Channel 6 Interrupt Enable"]
  #[inline(always)]
  pub fn dma_6(&mut self) -> Dma6W<'_, HstierSpec> {
    Dma6W::new(self, 30)
  }
}
