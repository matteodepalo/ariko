...
impl W {
  #[doc = "Bit 0 - Data Toggle Error"]
  #[inline(always)]
  pub fn datatgl(&mut self) -> DatatglW<'_, HstpiperrSpec> {
    DatatglW::new(self, 0)
  }
  #[doc = "Bit 1 - Data PID Error"]
  #[inline(always)]
  pub fn datapid(&mut self) -> DatapidW<'_, HstpiperrSpec> {
    DatapidW::new(self, 1)
  }
  #[doc = "Bit 2 - PID Error"]
  #[inline(always)]
  pub fn pid(&mut self) -> PidW<'_, HstpiperrSpec> {
    PidW::new(self, 2)
  }
  #[doc = "Bit 3 - Time-Out Error"]
  #[inline(always)]
  pub fn timeout(&mut self) -> TimeoutW<'_, HstpiperrSpec> {
    TimeoutW::new(self, 3)
  }
  #[doc = "Bit 4 - CRC16 Error"]
  #[inline(always)]
  pub fn crc16(&mut self) -> Crc16W<'_, HstpiperrSpec> {
    Crc16W::new(self, 4)
  }
  #[doc = "Bits 5:6 - Error Counter"]
  #[inline(always)]
  pub fn counter(&mut self) -> CounterW<'_, HstpiperrSpec> {
    CounterW::new(self, 5)
  }
}
#[doc = "Host Pipe Error Register (n = 0)\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpiperr::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstpiperr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
