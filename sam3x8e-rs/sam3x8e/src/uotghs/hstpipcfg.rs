...
pub type R = crate::R<HstpipcfgSpec>;
#[doc = "Register `HSTPIPCFG[%s]` writer"]
pub type W = crate::W<HstpipcfgSpec>;
...
impl W {
  #[doc = "Bit 1 - Pipe Memory Allocate"]
  #[inline(always)]
  pub fn alloc(&mut self) -> AllocW<'_, HstpipcfgSpec> {
    AllocW::new(self, 1)
  }
  #[doc = "Bits 2:3 - Pipe Banks"]
  #[inline(always)]
  pub fn pbk(&mut self) -> PbkW<'_, HstpipcfgSpec> {
    PbkW::new(self, 2)
  }
  #[doc = "Bits 4:6 - Pipe Size"]
  #[inline(always)]
  pub fn psize(&mut self) -> PsizeW<'_, HstpipcfgSpec> {
    PsizeW::new(self, 4)
  }
  #[doc = "Bits 8:9 - Pipe Token"]
  #[inline(always)]
  pub fn ptoken(&mut self) -> PtokenW<'_, HstpipcfgSpec> {
    PtokenW::new(self, 8)
  }
  #[doc = "Bit 10 - Automatic Switch"]
  #[inline(always)]
  pub fn autosw(&mut self) -> AutoswW<'_, HstpipcfgSpec> {
    AutoswW::new(self, 10)
  }
  #[doc = "Bits 12:13 - Pipe Type"]
  #[inline(always)]
  pub fn ptype(&mut self) -> PtypeW<'_, HstpipcfgSpec> {
    PtypeW::new(self, 12)
  }
  #[doc = "Bits 16:19 - Pipe Endpoint Number"]
  #[inline(always)]
  pub fn pepnum(&mut self) -> PepnumW<'_, HstpipcfgSpec> {
    PepnumW::new(self, 16)
  }
  #[doc = "Bits 24:31 - Pipe Interrupt Request Frequency"]
  #[inline(always)]
  pub fn intfrq(&mut self) -> IntfrqW<'_, HstpipcfgSpec> {
    IntfrqW::new(self, 24)
  }
}
#[doc = "Host Pipe Configuration Register (n = 0)\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipcfg::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hstpipcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HstpipcfgSpec;
impl crate::RegisterSpec for HstpipcfgSpec {
  type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipcfg::R`](R) reader structure"]
impl crate::Readable for HstpipcfgSpec {}
#[doc = "`write(|w| ..)` method takes [`hstpipcfg::W`](W) writer structure"]
impl crate::Writable for HstpipcfgSpec {
