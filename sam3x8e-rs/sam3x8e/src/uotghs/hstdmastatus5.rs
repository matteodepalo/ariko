...
impl W {
  #[doc = "Bit 0 - Channel Enable Status"]
  #[inline(always)]
  pub fn chann_enb(&mut self) -> ChannEnbW<'_, Hstdmastatus5Spec> {
    ChannEnbW::new(self, 0)
  }
  #[doc = "Bit 1 - Channel Active Status"]
  #[inline(always)]
  pub fn chann_act(&mut self) -> ChannActW<'_, Hstdmastatus5Spec> {
    ChannActW::new(self, 1)
  }
  #[doc = "Bit 4 - End of Channel Transfer Status"]
  #[inline(always)]
  pub fn end_tr_st(&mut self) -> EndTrStW<'_, Hstdmastatus5Spec> {
    EndTrStW::new(self, 4)
  }
  #[doc = "Bit 5 - End of Channel Buffer Status"]
  #[inline(always)]
  pub fn end_bf_st(&mut self) -> EndBfStW<'_, Hstdmastatus5Spec> {
    EndBfStW::new(self, 5)
  }
  #[doc = "Bit 6 - Descriptor Loaded Status"]
  #[inline(always)]
  pub fn desc_ldst(&mut self) -> DescLdstW<'_, Hstdmastatus5Spec> {
    DescLdstW::new(self, 6)
  }
  #[doc = "Bits 16:31 - Buffer Byte Count"]
  #[inline(always)]
  pub fn buff_count(&mut self) -> BuffCountW<'_, Hstdmastatus5Spec> {
