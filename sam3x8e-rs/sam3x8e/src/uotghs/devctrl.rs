...
impl W {
  #[doc = "Bits 0:6 - USB Address"]
  #[inline(always)]
  pub fn uadd(&mut self) -> UaddW<'_, DevctrlSpec> {
    UaddW::new(self, 0)
  }
  #[doc = "Bit 7 - Address Enable"]
  #[inline(always)]
  pub fn adden(&mut self) -> AddenW<'_, DevctrlSpec> {
    AddenW::new(self, 7)
  }
  #[doc = "Bit 8 - Detach"]
  #[inline(always)]
  pub fn detach(&mut self) -> DetachW<'_, DevctrlSpec> {
    DetachW::new(self, 8)
  }
  #[doc = "Bit 9 - Remote Wake-Up"]
  #[inline(always)]
  pub fn rmwkup(&mut self) -> RmwkupW<'_, DevctrlSpec> {
    RmwkupW::new(self, 9)
  }
  #[doc = "Bits 10:11 - Mode Configuration"]
  #[inline(always)]
  pub fn spdconf(&mut self) -> SpdconfW<'_, DevctrlSpec> {
    SpdconfW::new(self, 10)
  }
  #[doc = "Bit 12 - Low-Speed Mode Force"]
  #[inline(always)]
  pub fn ls(&mut self) -> LsW<'_, DevctrlSpec> {
    LsW::new(self, 12)
  }
  #[doc = "Bit 13 - Test mode J"]
  #[inline(always)]
  pub fn tstj(&mut self) -> TstjW<'_, DevctrlSpec> {
    TstjW::new(self, 13)
  }
  #[doc = "Bit 14 - Test mode K"]
  #[inline(always)]
  pub fn tstk(&mut self) -> TstkW<'_, DevctrlSpec> {
    TstkW::new(self, 14)
  }
  #[doc = "Bit 15 - Test packet mode"]
  #[inline(always)]
  pub fn tstpckt(&mut self) -> TstpcktW<'_, DevctrlSpec> {
    TstpcktW::new(self, 15)
  }
  #[doc = "Bit 16 - Specific Operational mode"]
  #[inline(always)]
  pub fn opmode2(&mut self) -> Opmode2W<'_, DevctrlSpec> {
