...
impl W {
  #[doc = "Bits 0:6 - USB Host Address"]
  #[inline(always)]
  pub fn hstaddrp4(&mut self) -> Hstaddrp4W<'_, Hstaddr2Spec> {
    Hstaddrp4W::new(self, 0)
  }
  #[doc = "Bits 8:14 - USB Host Address"]
  #[inline(always)]
  pub fn hstaddrp5(&mut self) -> Hstaddrp5W<'_, Hstaddr2Spec> {
    Hstaddrp5W::new(self, 8)
  }
  #[doc = "Bits 16:22 - USB Host Address"]
  #[inline(always)]
  pub fn hstaddrp6(&mut self) -> Hstaddrp6W<'_, Hstaddr2Spec> {
    Hstaddrp6W::new(self, 16)
  }
  #[doc = "Bits 24:30 - USB Host Address"]
  #[inline(always)]
  pub fn hstaddrp7(&mut self) -> Hstaddrp7W<'_, Hstaddr2Spec> {
