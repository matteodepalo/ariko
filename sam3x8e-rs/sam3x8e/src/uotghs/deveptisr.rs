...
pub type R = crate::R<DeveptisrSpec>;
...
#[doc = "Device Endpoint Status Register (n = 0)\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptisr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DeveptisrSpec;
impl crate::RegisterSpec for DeveptisrSpec {
  type Ux = u32;
}
#[doc = "`read()` method returns [`deveptisr::R`](R) reader structure"]
impl crate::Readable for DeveptisrSpec {}
