...
impl W {
  #[doc = "Bit 1 - Endpoint Memory Allocate"]
  #[inline(always)]
  pub fn alloc(&mut self) -> AllocW<'_, DeveptcfgSpec> {
    AllocW::new(self, 1)
  }
  #[doc = "Bits 2:3 - Endpoint Banks"]
  #[inline(always)]
  pub fn epbk(&mut self) -> EpbkW<'_, DeveptcfgSpec> {
    EpbkW::new(self, 2)
  }
  #[doc = "Bits 4:6 - Endpoint Size"]
  #[inline(always)]
  pub fn epsize(&mut self) -> EpsizeW<'_, DeveptcfgSpec> {
    EpsizeW::new(self, 4)
  }
  #[doc = "Bit 8 - Endpoint Direction"]
  #[inline(always)]
  pub fn epdir(&mut self) -> EpdirW<'_, DeveptcfgSpec> {
    EpdirW::new(self, 8)
  }
  #[doc = "Bit 9 - Automatic Switch"]
  #[inline(always)]
  pub fn autosw(&mut self) -> AutoswW<'_, DeveptcfgSpec> {
    AutoswW::new(self, 9)
  }
  #[doc = "Bits 11:12 - Endpoint Type"]
  #[inline(always)]
  pub fn eptype(&mut self) -> EptypeW<'_, DeveptcfgSpec> {
    EptypeW::new(self, 11)
  }
  #[doc = "Bits 13:14 - Number of transaction per microframe for isochronous endpoint"]
  #[inline(always)]
  pub fn nbtrans(&mut self) -> NbtransW<'_, DeveptcfgSpec> {
    NbtransW::new(self, 13)
  }
}
#[doc = "Device Endpoint Configuration Register (n = 0)\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptcfg::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`deveptcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
