...
pub type R = crate::R<HstpipimrSpec>;
...
#[doc = "Host Pipe Mask Register (n = 0)\n\nYou can [`read`](crate::Reg::read) this register and get [`hstpipimr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HstpipimrSpec;
impl crate::RegisterSpec for HstpipimrSpec {
  type Ux = u32;
}
#[doc = "`read()` method returns [`hstpipimr::R`](R) reader structure"]
impl crate::Readable for HstpipimrSpec {}
