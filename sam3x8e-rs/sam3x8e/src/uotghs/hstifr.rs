...
impl W {
  ...
  #[inline(always)]
  pub fn dconnis(&mut self) -> DconnisW<'_, HstifrSpec> {
    DconnisW::new(self, 0)
  }
  #[doc = "Bit 1 - Device Disconnection Interrupt Set"]
  #[inline(always)]
  pub fn ddiscis(&mut self) -> DdiscisW<'_, HstifrSpec> {
    DdiscisW::new(self, 1)
  }
  #[doc = "Bit 2 - USB Reset Sent Interrupt Set"]
  #[inline(always)]
  pub fn rstis(&mut self) -> RstisW<'_, HstifrSpec> {
    RstisW::new(self, 2)
  }
  #[doc = "Bit 3 - Downstream Resume Sent Interrupt Set"]
  #[inline(always)]
  pub fn rsmedis(&mut self) -> RsmedisW<'_, HstifrSpec> {
    RsmedisW::new(self, 3)
  }
  #[doc = "Bit 4 - Upstream Resume Received Interrupt Set"]
  #[inline(always)]
  pub fn rxrsmis(&mut self) -> RxrsmisW<'_, HstifrSpec> {
    RxrsmisW::new(self, 4)
  }
  #[doc = "Bit 5 - Host Start of Frame Interrupt Set"]
  #[inline(always)]
  pub fn hsofis(&mut self) -> HsofisW<'_, HstifrSpec> {
    HsofisW::new(self, 5)
  }
  #[doc = "Bit 6 - Host Wake-Up Interrupt Set"]
  #[inline(always)]
  pub fn hwupis(&mut self) -> HwupisW<'_, HstifrSpec> {
    HwupisW::new(self, 6)
  }
  #[doc = "Bit 25 - DMA Channel 1 Interrupt Set"]
  #[inline(always)]
  pub fn dma_1(&mut self) -> Dma1W<'_, HstifrSpec> {
    Dma1W::new(self, 25)
  }
  #[doc = "Bit 26 - DMA Channel 2 Interrupt Set"]
  #[inline(always)]
  pub fn dma_2(&mut self) -> Dma2W<'_, HstifrSpec> {
    Dma2W::new(self, 26)
  }
  #[doc = "Bit 27 - DMA Channel 3 Interrupt Set"]
  #[inline(always)]
  pub fn dma_3(&mut self) -> Dma3W<'_, HstifrSpec> {
    Dma3W::new(self, 27)
  }
  #[doc = "Bit 28 - DMA Channel 4 Interrupt Set"]
  #[inline(always)]
  pub fn dma_4(&mut self) -> Dma4W<'_, HstifrSpec> {
    Dma4W::new(self, 28)
  }
  #[doc = "Bit 29 - DMA Channel 5 Interrupt Set"]
  #[inline(always)]
  pub fn dma_5(&mut self) -> Dma5W<'_, HstifrSpec> {
    Dma5W::new(self, 29)
  }
  #[doc = "Bit 30 - DMA Channel 6 Interrupt Set"]
  #[inline(always)]
  pub fn dma_6(&mut self) -> Dma6W<'_, HstifrSpec> {
    Dma6W::new(self, 30)
  }
}
