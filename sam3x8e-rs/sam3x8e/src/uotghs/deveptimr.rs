...
pub type R = crate::R<DeveptimrSpec>;
...
#[doc = "Device Endpoint Mask Register (n = 0)\n\nYou can [`read`](crate::Reg::read) this register and get [`deveptimr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DeveptimrSpec;
impl crate::RegisterSpec for DeveptimrSpec {
  type Ux = u32;
}
#[doc = "`read()` method returns [`deveptimr::R`](R) reader structure"]
impl crate::Readable for DeveptimrSpec {}
