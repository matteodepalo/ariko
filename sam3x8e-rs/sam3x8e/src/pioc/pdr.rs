...
impl W {
  ...
  #[inline(always)]
  pub fn p0(&mut self) -> P0W<'_, PdrSpec> {
    P0W::new(self, 0)
  }
  #[doc = "Bit 1 - PIO Disable"]
  #[inline(always)]
  pub fn p1(&mut self) -> P1W<'_, PdrSpec> {
    P1W::new(self, 1)
  }
  #[doc = "Bit 2 - PIO Disable"]
  #[inline(always)]
  pub fn p2(&mut self) -> P2W<'_, PdrSpec> {
    P2W::new(self, 2)
  }
  #[doc = "Bit 3 - PIO Disable"]
  #[inline(always)]
  pub fn p3(&mut self) -> P3W<'_, PdrSpec> {
    P3W::new(self, 3)
  }
  #[doc = "Bit 4 - PIO Disable"]
  #[inline(always)]
  pub fn p4(&mut self) -> P4W<'_, PdrSpec> {
    P4W::new(self, 4)
  }
  #[doc = "Bit 5 - PIO Disable"]
  #[inline(always)]
  pub fn p5(&mut self) -> P5W<'_, PdrSpec> {
    P5W::new(self, 5)
  }
  #[doc = "Bit 6 - PIO Disable"]
  #[inline(always)]
  pub fn p6(&mut self) -> P6W<'_, PdrSpec> {
    P6W::new(self, 6)
  }
  #[doc = "Bit 7 - PIO Disable"]
  #[inline(always)]
  pub fn p7(&mut self) -> P7W<'_, PdrSpec> {
    P7W::new(self, 7)
  }
  #[doc = "Bit 8 - PIO Disable"]
  #[inline(always)]
  pub fn p8(&mut self) -> P8W<'_, PdrSpec> {
    P8W::new(self, 8)
  }
  #[doc = "Bit 9 - PIO Disable"]
  #[inline(always)]
  pub fn p9(&mut self) -> P9W<'_, PdrSpec> {
    P9W::new(self, 9)
  }
  #[doc = "Bit 10 - PIO Disable"]
  #[inline(always)]
  pub fn p10(&mut self) -> P10W<'_, PdrSpec> {
    P10W::new(self, 10)
  }
  #[doc = "Bit 11 - PIO Disable"]
  #[inline(always)]
  pub fn p11(&mut self) -> P11W<'_, PdrSpec> {
    P11W::new(self, 11)
  }
  #[doc = "Bit 12 - PIO Disable"]
  #[inline(always)]
  pub fn p12(&mut self) -> P12W<'_, PdrSpec> {
    P12W::new(self, 12)
  }
  #[doc = "Bit 13 - PIO Disable"]
  #[inline(always)]
  pub fn p13(&mut self) -> P13W<'_, PdrSpec> {
    P13W::new(self, 13)
  }
  #[doc = "Bit 14 - PIO Disable"]
  #[inline(always)]
  pub fn p14(&mut self) -> P14W<'_, PdrSpec> {
    P14W::new(self, 14)
  }
  #[doc = "Bit 15 - PIO Disable"]
  #[inline(always)]
  pub fn p15(&mut self) -> P15W<'_, PdrSpec> {
    P15W::new(self, 15)
  }
  #[doc = "Bit 16 - PIO Disable"]
  #[inline(always)]
  pub fn p16(&mut self) -> P16W<'_, PdrSpec> {
    P16W::new(self, 16)
  }
  #[doc = "Bit 17 - PIO Disable"]
  #[inline(always)]
  pub fn p17(&mut self) -> P17W<'_, PdrSpec> {
    P17W::new(self, 17)
  }
  #[doc = "Bit 18 - PIO Disable"]
  #[inline(always)]
  pub fn p18(&mut self) -> P18W<'_, PdrSpec> {
    P18W::new(self, 18)
  }
  #[doc = "Bit 19 - PIO Disable"]
  #[inline(always)]
  pub fn p19(&mut self) -> P19W<'_, PdrSpec> {
    P19W::new(self, 19)
  }
  #[doc = "Bit 20 - PIO Disable"]
  #[inline(always)]
  pub fn p20(&mut self) -> P20W<'_, PdrSpec> {
    P20W::new(self, 20)
  }
  #[doc = "Bit 21 - PIO Disable"]
  #[inline(always)]
  pub fn p21(&mut self) -> P21W<'_, PdrSpec> {
    P21W::new(self, 21)
  }
  #[doc = "Bit 22 - PIO Disable"]
  #[inline(always)]
  pub fn p22(&mut self) -> P22W<'_, PdrSpec> {
    P22W::new(self, 22)
  }
  #[doc = "Bit 23 - PIO Disable"]
  #[inline(always)]
  pub fn p23(&mut self) -> P23W<'_, PdrSpec> {
    P23W::new(self, 23)
  }
  #[doc = "Bit 24 - PIO Disable"]
  #[inline(always)]
  pub fn p24(&mut self) -> P24W<'_, PdrSpec> {
    P24W::new(self, 24)
  }
  #[doc = "Bit 25 - PIO Disable"]
  #[inline(always)]
  pub fn p25(&mut self) -> P25W<'_, PdrSpec> {
    P25W::new(self, 25)
  }
  #[doc = "Bit 26 - PIO Disable"]
  #[inline(always)]
  pub fn p26(&mut self) -> P26W<'_, PdrSpec> {
    P26W::new(self, 26)
  }
  #[doc = "Bit 27 - PIO Disable"]
  #[inline(always)]
  pub fn p27(&mut self) -> P27W<'_, PdrSpec> {
    P27W::new(self, 27)
  }
  #[doc = "Bit 28 - PIO Disable"]
  #[inline(always)]
  pub fn p28(&mut self) -> P28W<'_, PdrSpec> {
    P28W::new(self, 28)
  }
  #[doc = "Bit 29 - PIO Disable"]
  #[inline(always)]
  pub fn p29(&mut self) -> P29W<'_, PdrSpec> {
    P29W::new(self, 29)
  }
  #[doc = "Bit 30 - PIO Disable"]
  #[inline(always)]
  pub fn p30(&mut self) -> P30W<'_, PdrSpec> {
    P30W::new(self, 30)
  }
  #[doc = "Bit 31 - PIO Disable"]
  #[inline(always)]
  pub fn p31(&mut self) -> P31W<'_, PdrSpec> {
    P31W::new(self, 31)
  }
}
