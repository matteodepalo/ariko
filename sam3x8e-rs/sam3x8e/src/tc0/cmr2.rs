...
impl W {
  #[doc = "Bits 0:2 - Clock Selection"]
  #[inline(always)]
  pub fn tcclks(&mut self) -> TcclksW<'_, Cmr2Spec> {
    TcclksW::new(self, 0)
  }
  #[doc = "Bit 3 - Clock Invert"]
  #[inline(always)]
  pub fn clki(&mut self) -> ClkiW<'_, Cmr2Spec> {
    ClkiW::new(self, 3)
  }
  #[doc = "Bits 4:5 - Burst Signal Selection"]
  #[inline(always)]
  pub fn burst(&mut self) -> BurstW<'_, Cmr2Spec> {
    BurstW::new(self, 4)
  }
  #[doc = "Bit 6 - Counter Clock Stopped with RB Loading"]
  #[inline(always)]
  pub fn ldbstop(&mut self) -> LdbstopW<'_, Cmr2Spec> {
    LdbstopW::new(self, 6)
  }
  #[doc = "Bit 7 - Counter Clock Disable with RB Loading"]
  #[inline(always)]
  pub fn ldbdis(&mut self) -> LdbdisW<'_, Cmr2Spec> {
    LdbdisW::new(self, 7)
  }
  #[doc = "Bits 8:9 - External Trigger Edge Selection"]
  #[inline(always)]
  pub fn etrgedg(&mut self) -> EtrgedgW<'_, Cmr2Spec> {
    EtrgedgW::new(self, 8)
  }
  #[doc = "Bit 10 - TIOA or TIOB External Trigger Selection"]
  #[inline(always)]
  pub fn abetrg(&mut self) -> AbetrgW<'_, Cmr2Spec> {
    AbetrgW::new(self, 10)
  }
  #[doc = "Bit 14 - RC Compare Trigger Enable"]
  #[inline(always)]
  pub fn cpctrg(&mut self) -> CpctrgW<'_, Cmr2Spec> {
    CpctrgW::new(self, 14)
  }
  #[doc = "Bit 15 - Waveform Mode"]
  #[inline(always)]
  pub fn wave(&mut self) -> WaveW<'_, Cmr2Spec> {
    WaveW::new(self, 15)
  }
  #[doc = "Bits 16:17 - RA Loading Edge Selection"]
  #[inline(always)]
  pub fn ldra(&mut self) -> LdraW<'_, Cmr2Spec> {
    LdraW::new(self, 16)
  }
  #[doc = "Bits 18:19 - RB Loading Edge Selection"]
  #[inline(always)]
  pub fn ldrb(&mut self) -> LdrbW<'_, Cmr2Spec> {
    LdrbW::new(self, 18)
  }
}
