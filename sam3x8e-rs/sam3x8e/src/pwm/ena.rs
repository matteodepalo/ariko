...
impl W {
  ...
  #[inline(always)]
  pub fn chid0(&mut self) -> Chid0W<'_, EnaSpec> {
    Chid0W::new(self, 0)
  }
  #[doc = "Bit 1 - Channel ID"]
  #[inline(always)]
  pub fn chid1(&mut self) -> Chid1W<'_, EnaSpec> {
    Chid1W::new(self, 1)
  }
  #[doc = "Bit 2 - Channel ID"]
  #[inline(always)]
  pub fn chid2(&mut self) -> Chid2W<'_, EnaSpec> {
    Chid2W::new(self, 2)
  }
  #[doc = "Bit 3 - Channel ID"]
  #[inline(always)]
  pub fn chid3(&mut self) -> Chid3W<'_, EnaSpec> {
    Chid3W::new(self, 3)
  }
  #[doc = "Bit 4 - Channel ID"]
  #[inline(always)]
  pub fn chid4(&mut self) -> Chid4W<'_, EnaSpec> {
    Chid4W::new(self, 4)
  }
  #[doc = "Bit 5 - Channel ID"]
  #[inline(always)]
  pub fn chid5(&mut self) -> Chid5W<'_, EnaSpec> {
    Chid5W::new(self, 5)
  }
  #[doc = "Bit 6 - Channel ID"]
  #[inline(always)]
  pub fn chid6(&mut self) -> Chid6W<'_, EnaSpec> {
    Chid6W::new(self, 6)
  }
  #[doc = "Bit 7 - Channel ID"]
  #[inline(always)]
  pub fn chid7(&mut self) -> Chid7W<'_, EnaSpec> {
    Chid7W::new(self, 7)
  }
}
