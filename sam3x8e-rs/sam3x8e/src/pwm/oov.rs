...
impl W {
  #[doc = "Bit 0 - Output Override Value for PWMH output of the channel 0"]
  #[inline(always)]
  pub fn oovh0(&mut self) -> Oovh0W<'_, OovSpec> {
    Oovh0W::new(self, 0)
  }
  #[doc = "Bit 1 - Output Override Value for PWMH output of the channel 1"]
  #[inline(always)]
  pub fn oovh1(&mut self) -> Oovh1W<'_, OovSpec> {
    Oovh1W::new(self, 1)
  }
  #[doc = "Bit 2 - Output Override Value for PWMH output of the channel 2"]
  #[inline(always)]
  pub fn oovh2(&mut self) -> Oovh2W<'_, OovSpec> {
    Oovh2W::new(self, 2)
  }
  #[doc = "Bit 3 - Output Override Value for PWMH output of the channel 3"]
  #[inline(always)]
  pub fn oovh3(&mut self) -> Oovh3W<'_, OovSpec> {
    Oovh3W::new(self, 3)
  }
  #[doc = "Bit 4 - Output Override Value for PWMH output of the channel 4"]
  #[inline(always)]
  pub fn oovh4(&mut self) -> Oovh4W<'_, OovSpec> {
    Oovh4W::new(self, 4)
  }
  #[doc = "Bit 5 - Output Override Value for PWMH output of the channel 5"]
  #[inline(always)]
  pub fn oovh5(&mut self) -> Oovh5W<'_, OovSpec> {
    Oovh5W::new(self, 5)
  }
  #[doc = "Bit 6 - Output Override Value for PWMH output of the channel 6"]
  #[inline(always)]
  pub fn oovh6(&mut self) -> Oovh6W<'_, OovSpec> {
    Oovh6W::new(self, 6)
  }
  #[doc = "Bit 7 - Output Override Value for PWMH output of the channel 7"]
  #[inline(always)]
  pub fn oovh7(&mut self) -> Oovh7W<'_, OovSpec> {
    Oovh7W::new(self, 7)
  }
  #[doc = "Bit 16 - Output Override Value for PWML output of the channel 0"]
  #[inline(always)]
  pub fn oovl0(&mut self) -> Oovl0W<'_, OovSpec> {
    Oovl0W::new(self, 16)
  }
  #[doc = "Bit 17 - Output Override Value for PWML output of the channel 1"]
  #[inline(always)]
  pub fn oovl1(&mut self) -> Oovl1W<'_, OovSpec> {
    Oovl1W::new(self, 17)
  }
  #[doc = "Bit 18 - Output Override Value for PWML output of the channel 2"]
  #[inline(always)]
  pub fn oovl2(&mut self) -> Oovl2W<'_, OovSpec> {
    Oovl2W::new(self, 18)
  }
  #[doc = "Bit 19 - Output Override Value for PWML output of the channel 3"]
  #[inline(always)]
  pub fn oovl3(&mut self) -> Oovl3W<'_, OovSpec> {
    Oovl3W::new(self, 19)
  }
  #[doc = "Bit 20 - Output Override Value for PWML output of the channel 4"]
  #[inline(always)]
  pub fn oovl4(&mut self) -> Oovl4W<'_, OovSpec> {
    Oovl4W::new(self, 20)
  }
  #[doc = "Bit 21 - Output Override Value for PWML output of the channel 5"]
  #[inline(always)]
  pub fn oovl5(&mut self) -> Oovl5W<'_, OovSpec> {
    Oovl5W::new(self, 21)
  }
  #[doc = "Bit 22 - Output Override Value for PWML output of the channel 6"]
  #[inline(always)]
  pub fn oovl6(&mut self) -> Oovl6W<'_, OovSpec> {
    Oovl6W::new(self, 22)
  }
  #[doc = "Bit 23 - Output Override Value for PWML output of the channel 7"]
  #[inline(always)]
  pub fn oovl7(&mut self) -> Oovl7W<'_, OovSpec> {
    Oovl7W::new(self, 23)
  }
}
