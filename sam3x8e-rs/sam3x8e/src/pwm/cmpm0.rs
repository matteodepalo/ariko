...
impl W {
  #[doc = "Bit 0 - Comparison x Enable"]
  #[inline(always)]
  pub fn cen(&mut self) -> CenW<'_, Cmpm0Spec> {
    CenW::new(self, 0)
  }
  #[doc = "Bits 4:7 - Comparison x Trigger"]
  #[inline(always)]
  pub fn ctr(&mut self) -> CtrW<'_, Cmpm0Spec> {
    CtrW::new(self, 4)
  }
  #[doc = "Bits 8:11 - Comparison x Period"]
  #[inline(always)]
  pub fn cpr(&mut self) -> CprW<'_, Cmpm0Spec> {
    CprW::new(self, 8)
  }
  #[doc = "Bits 12:15 - Comparison x Period Counter"]
  #[inline(always)]
  pub fn cprcnt(&mut self) -> CprcntW<'_, Cmpm0Spec> {
    CprcntW::new(self, 12)
  }
  #[doc = "Bits 16:19 - Comparison x Update Period"]
  #[inline(always)]
  pub fn cupr(&mut self) -> CuprW<'_, Cmpm0Spec> {
    CuprW::new(self, 16)
  }
  #[doc = "Bits 20:23 - Comparison x Update Period Counter"]
  #[inline(always)]
  pub fn cuprcnt(&mut self) -> CuprcntW<'_, Cmpm0Spec> {
