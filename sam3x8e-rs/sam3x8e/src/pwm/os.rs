...
impl W {
  #[doc = "Bit 0 - Output Selection for PWMH output of the channel 0"]
  #[inline(always)]
  pub fn osh0(&mut self) -> Osh0W<'_, OsSpec> {
    Osh0W::new(self, 0)
  }
  #[doc = "Bit 1 - Output Selection for PWMH output of the channel 1"]
  #[inline(always)]
  pub fn osh1(&mut self) -> Osh1W<'_, OsSpec> {
    Osh1W::new(self, 1)
  }
  #[doc = "Bit 2 - Output Selection for PWMH output of the channel 2"]
  #[inline(always)]
  pub fn osh2(&mut self) -> Osh2W<'_, OsSpec> {
    Osh2W::new(self, 2)
  }
  #[doc = "Bit 3 - Output Selection for PWMH output of the channel 3"]
  #[inline(always)]
  pub fn osh3(&mut self) -> Osh3W<'_, OsSpec> {
    Osh3W::new(self, 3)
  }
  #[doc = "Bit 4 - Output Selection for PWMH output of the channel 4"]
  #[inline(always)]
  pub fn osh4(&mut self) -> Osh4W<'_, OsSpec> {
    Osh4W::new(self, 4)
  }
  #[doc = "Bit 5 - Output Selection for PWMH output of the channel 5"]
  #[inline(always)]
  pub fn osh5(&mut self) -> Osh5W<'_, OsSpec> {
    Osh5W::new(self, 5)
  }
  #[doc = "Bit 6 - Output Selection for PWMH output of the channel 6"]
  #[inline(always)]
  pub fn osh6(&mut self) -> Osh6W<'_, OsSpec> {
    Osh6W::new(self, 6)
  }
  #[doc = "Bit 7 - Output Selection for PWMH output of the channel 7"]
  #[inline(always)]
  pub fn osh7(&mut self) -> Osh7W<'_, OsSpec> {
    Osh7W::new(self, 7)
  }
  #[doc = "Bit 16 - Output Selection for PWML output of the channel 0"]
  #[inline(always)]
  pub fn osl0(&mut self) -> Osl0W<'_, OsSpec> {
    Osl0W::new(self, 16)
  }
  #[doc = "Bit 17 - Output Selection for PWML output of the channel 1"]
  #[inline(always)]
  pub fn osl1(&mut self) -> Osl1W<'_, OsSpec> {
    Osl1W::new(self, 17)
  }
  #[doc = "Bit 18 - Output Selection for PWML output of the channel 2"]
  #[inline(always)]
  pub fn osl2(&mut self) -> Osl2W<'_, OsSpec> {
    Osl2W::new(self, 18)
  }
  #[doc = "Bit 19 - Output Selection for PWML output of the channel 3"]
  #[inline(always)]
  pub fn osl3(&mut self) -> Osl3W<'_, OsSpec> {
    Osl3W::new(self, 19)
  }
  #[doc = "Bit 20 - Output Selection for PWML output of the channel 4"]
  #[inline(always)]
  pub fn osl4(&mut self) -> Osl4W<'_, OsSpec> {
    Osl4W::new(self, 20)
  }
  #[doc = "Bit 21 - Output Selection for PWML output of the channel 5"]
  #[inline(always)]
  pub fn osl5(&mut self) -> Osl5W<'_, OsSpec> {
    Osl5W::new(self, 21)
  }
  #[doc = "Bit 22 - Output Selection for PWML output of the channel 6"]
  #[inline(always)]
  pub fn osl6(&mut self) -> Osl6W<'_, OsSpec> {
    Osl6W::new(self, 22)
  }
  #[doc = "Bit 23 - Output Selection for PWML output of the channel 7"]
  #[inline(always)]
  pub fn osl7(&mut self) -> Osl7W<'_, OsSpec> {
    Osl7W::new(self, 23)
  }
}
