...
impl W {
  #[doc = "Bit 0 - Comparison 0 Selection"]
  #[inline(always)]
  pub fn csel0(&mut self) -> Csel0W<'_, ElmrSpec> {
    Csel0W::new(self, 0)
  }
  #[doc = "Bit 1 - Comparison 1 Selection"]
  #[inline(always)]
  pub fn csel1(&mut self) -> Csel1W<'_, ElmrSpec> {
    Csel1W::new(self, 1)
  }
  #[doc = "Bit 2 - Comparison 2 Selection"]
  #[inline(always)]
  pub fn csel2(&mut self) -> Csel2W<'_, ElmrSpec> {
    Csel2W::new(self, 2)
  }
  #[doc = "Bit 3 - Comparison 3 Selection"]
  #[inline(always)]
  pub fn csel3(&mut self) -> Csel3W<'_, ElmrSpec> {
    Csel3W::new(self, 3)
  }
  #[doc = "Bit 4 - Comparison 4 Selection"]
  #[inline(always)]
  pub fn csel4(&mut self) -> Csel4W<'_, ElmrSpec> {
    Csel4W::new(self, 4)
  }
  #[doc = "Bit 5 - Comparison 5 Selection"]
  #[inline(always)]
  pub fn csel5(&mut self) -> Csel5W<'_, ElmrSpec> {
    Csel5W::new(self, 5)
  }
  #[doc = "Bit 6 - Comparison 6 Selection"]
  #[inline(always)]
  pub fn csel6(&mut self) -> Csel6W<'_, ElmrSpec> {
    Csel6W::new(self, 6)
  }
  #[doc = "Bit 7 - Comparison 7 Selection"]
  #[inline(always)]
  pub fn csel7(&mut self) -> Csel7W<'_, ElmrSpec> {
    Csel7W::new(self, 7)
  }
}
#[doc = "PWM Event Line 0 Mode Register\n\nYou can [`read`](crate::Reg::read) this register and get [`elmr::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`elmr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ElmrSpec;
