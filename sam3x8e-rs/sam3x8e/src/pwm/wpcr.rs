...
impl W {
  ...
  #[inline(always)]
  pub fn wpcmd(&mut self) -> WpcmdW<'_, WpcrSpec> {
    WpcmdW::new(self, 0)
  }
  #[doc = "Bit 2 - Write Protect Register Group 0"]
  #[inline(always)]
  pub fn wprg0(&mut self) -> Wprg0W<'_, WpcrSpec> {
    Wprg0W::new(self, 2)
  }
  #[doc = "Bit 3 - Write Protect Register Group 1"]
  #[inline(always)]
  pub fn wprg1(&mut self) -> Wprg1W<'_, WpcrSpec> {
    Wprg1W::new(self, 3)
  }
  #[doc = "Bit 4 - Write Protect Register Group 2"]
  #[inline(always)]
  pub fn wprg2(&mut self) -> Wprg2W<'_, WpcrSpec> {
    Wprg2W::new(self, 4)
  }
  #[doc = "Bit 5 - Write Protect Register Group 3"]
  #[inline(always)]
  pub fn wprg3(&mut self) -> Wprg3W<'_, WpcrSpec> {
    Wprg3W::new(self, 5)
  }
  #[doc = "Bit 6 - Write Protect Register Group 4"]
  #[inline(always)]
  pub fn wprg4(&mut self) -> Wprg4W<'_, WpcrSpec> {
    Wprg4W::new(self, 6)
  }
  #[doc = "Bit 7 - Write Protect Register Group 5"]
  #[inline(always)]
  pub fn wprg5(&mut self) -> Wprg5W<'_, WpcrSpec> {
    Wprg5W::new(self, 7)
  }
  #[doc = "Bits 8:31 - Write Protect Key"]
  #[inline(always)]
  pub fn wpkey(&mut self) -> WpkeyW<'_, WpcrSpec> {
    WpkeyW::new(self, 8)
  }
}
