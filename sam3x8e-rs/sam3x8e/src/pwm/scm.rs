...
impl W {
  #[doc = "Bit 0 - Synchronous Channel 0"]
  #[inline(always)]
  pub fn sync0(&mut self) -> Sync0W<'_, ScmSpec> {
    Sync0W::new(self, 0)
  }
  #[doc = "Bit 1 - Synchronous Channel 1"]
  #[inline(always)]
  pub fn sync1(&mut self) -> Sync1W<'_, ScmSpec> {
    Sync1W::new(self, 1)
  }
  #[doc = "Bit 2 - Synchronous Channel 2"]
  #[inline(always)]
  pub fn sync2(&mut self) -> Sync2W<'_, ScmSpec> {
    Sync2W::new(self, 2)
  }
  #[doc = "Bit 3 - Synchronous Channel 3"]
  #[inline(always)]
  pub fn sync3(&mut self) -> Sync3W<'_, ScmSpec> {
    Sync3W::new(self, 3)
  }
  #[doc = "Bit 4 - Synchronous Channel 4"]
  #[inline(always)]
  pub fn sync4(&mut self) -> Sync4W<'_, ScmSpec> {
    Sync4W::new(self, 4)
  }
  #[doc = "Bit 5 - Synchronous Channel 5"]
  #[inline(always)]
  pub fn sync5(&mut self) -> Sync5W<'_, ScmSpec> {
    Sync5W::new(self, 5)
  }
  #[doc = "Bit 6 - Synchronous Channel 6"]
  #[inline(always)]
  pub fn sync6(&mut self) -> Sync6W<'_, ScmSpec> {
    Sync6W::new(self, 6)
  }
  #[doc = "Bit 7 - Synchronous Channel 7"]
  #[inline(always)]
  pub fn sync7(&mut self) -> Sync7W<'_, ScmSpec> {
    Sync7W::new(self, 7)
  }
  #[doc = "Bits 16:17 - Synchronous Channels Update Mode"]
  #[inline(always)]
  pub fn updm(&mut self) -> UpdmW<'_, ScmSpec> {
    UpdmW::new(self, 16)
  }
  #[doc = "Bit 20 - PDC Transfer Request Mode"]
  #[inline(always)]
  pub fn ptrm(&mut self) -> PtrmW<'_, ScmSpec> {
    PtrmW::new(self, 20)
  }
  #[doc = "Bits 21:23 - PDC Transfer Request Comparison Selection"]
  #[inline(always)]
  pub fn ptrcs(&mut self) -> PtrcsW<'_, ScmSpec> {
    PtrcsW::new(self, 21)
  }
}
