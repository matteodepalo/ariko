...
impl W {
  #[doc = "Bits 0:3 - Channel Pre-scaler"]
  #[inline(always)]
  pub fn cpre(&mut self) -> CpreW<'_, Cmr1Spec> {
    CpreW::new(self, 0)
  }
  #[doc = "Bit 8 - Channel Alignment"]
  #[inline(always)]
  pub fn calg(&mut self) -> CalgW<'_, Cmr1Spec> {
    CalgW::new(self, 8)
  }
  #[doc = "Bit 9 - Channel Polarity"]
  #[inline(always)]
  pub fn cpol(&mut self) -> CpolW<'_, Cmr1Spec> {
    CpolW::new(self, 9)
  }
  #[doc = "Bit 10 - Counter Event Selection"]
  #[inline(always)]
  pub fn ces(&mut self) -> CesW<'_, Cmr1Spec> {
    CesW::new(self, 10)
  }
  #[doc = "Bit 16 - Dead-Time Generator Enable"]
  #[inline(always)]
  pub fn dte(&mut self) -> DteW<'_, Cmr1Spec> {
    DteW::new(self, 16)
  }
  #[doc = "Bit 17 - Dead-Time PWMHx Output Inverted"]
  #[inline(always)]
  pub fn dthi(&mut self) -> DthiW<'_, Cmr1Spec> {
    DthiW::new(self, 17)
  }
  #[doc = "Bit 18 - Dead-Time PWMLx Output Inverted"]
  #[inline(always)]
  pub fn dtli(&mut self) -> DtliW<'_, Cmr1Spec> {
    DtliW::new(self, 18)
  }
}
