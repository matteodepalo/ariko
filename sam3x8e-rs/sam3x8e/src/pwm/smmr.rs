...
impl W {
  #[doc = "Bit 0 - Gray Count ENable"]
  #[inline(always)]
  pub fn gcen0(&mut self) -> Gcen0W<'_, SmmrSpec> {
    Gcen0W::new(self, 0)
  }
  #[doc = "Bit 1 - Gray Count ENable"]
  #[inline(always)]
  pub fn gcen1(&mut self) -> Gcen1W<'_, SmmrSpec> {
    Gcen1W::new(self, 1)
  }
  #[doc = "Bit 2 - Gray Count ENable"]
  #[inline(always)]
  pub fn gcen2(&mut self) -> Gcen2W<'_, SmmrSpec> {
    Gcen2W::new(self, 2)
  }
  #[doc = "Bit 3 - Gray Count ENable"]
  #[inline(always)]
  pub fn gcen3(&mut self) -> Gcen3W<'_, SmmrSpec> {
    Gcen3W::new(self, 3)
  }
  #[doc = "Bit 16 - DOWN Count"]
  #[inline(always)]
  pub fn down0(&mut self) -> Down0W<'_, SmmrSpec> {
    Down0W::new(self, 16)
  }
  #[doc = "Bit 17 - DOWN Count"]
  #[inline(always)]
  pub fn down1(&mut self) -> Down1W<'_, SmmrSpec> {
    Down1W::new(self, 17)
  }
  #[doc = "Bit 18 - DOWN Count"]
  #[inline(always)]
  pub fn down2(&mut self) -> Down2W<'_, SmmrSpec> {
    Down2W::new(self, 18)
  }
  #[doc = "Bit 19 - DOWN Count"]
  #[inline(always)]
  pub fn down3(&mut self) -> Down3W<'_, SmmrSpec> {
    Down3W::new(self, 19)
  }
}
