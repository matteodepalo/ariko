...
impl W {
  ...
  #[inline(always)]
  pub fn cenupd(&mut self) -> CenupdW<'_, Cmpmupd0Spec> {
    CenupdW::new(self, 0)
  }
  #[doc = "Bits 4:7 - Comparison x Trigger Update"]
  #[inline(always)]
  pub fn ctrupd(&mut self) -> CtrupdW<'_, Cmpmupd0Spec> {
    CtrupdW::new(self, 4)
  }
  #[doc = "Bits 8:11 - Comparison x Period Update"]
  #[inline(always)]
  pub fn cprupd(&mut self) -> CprupdW<'_, Cmpmupd0Spec> {
    CprupdW::new(self, 8)
  }
  #[doc = "Bits 16:19 - Comparison x Update Period Update"]
  #[inline(always)]
  pub fn cuprupd(&mut self) -> CuprupdW<'_, Cmpmupd0Spec> {
