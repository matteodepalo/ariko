...
impl W {
  #[doc = "Bits 0:15 - Real-time Timer Prescaler Value"]
  #[inline(always)]
  pub fn rtpres(&mut self) -> RtpresW<'_, MrSpec> {
    RtpresW::new(self, 0)
  }
  #[doc = "Bit 16 - Alarm Interrupt Enable"]
  #[inline(always)]
  pub fn almien(&mut self) -> AlmienW<'_, MrSpec> {
    AlmienW::new(self, 16)
  }
  #[doc = "Bit 17 - Real-time Timer Increment Interrupt Enable"]
  #[inline(always)]
  pub fn rttincien(&mut self) -> RttincienW<'_, MrSpec> {
    RttincienW::new(self, 17)
  }
  #[doc = "Bit 18 - Real-time Timer Restart"]
  #[inline(always)]
  pub fn rttrst(&mut self) -> RttrstW<'_, MrSpec> {
    RttrstW::new(self, 18)
  }
}
