...
impl W {
  #[doc = "Bits 0:1 - Transmit Clock Selection"]
  #[inline(always)]
  pub fn cks(&mut self) -> CksW<'_, TcmrSpec> {
    CksW::new(self, 0)
  }
  #[doc = "Bits 2:4 - Transmit Clock Output Mode Selection"]
  #[inline(always)]
  pub fn cko(&mut self) -> CkoW<'_, TcmrSpec> {
    CkoW::new(self, 2)
  }
  #[doc = "Bit 5 - Transmit Clock Inversion"]
  #[inline(always)]
  pub fn cki(&mut self) -> CkiW<'_, TcmrSpec> {
    CkiW::new(self, 5)
  }
  #[doc = "Bits 6:7 - Transmit Clock Gating Selection"]
  #[inline(always)]
  pub fn ckg(&mut self) -> CkgW<'_, TcmrSpec> {
    CkgW::new(self, 6)
  }
  #[doc = "Bits 8:11 - Transmit Start Selection"]
  #[inline(always)]
  pub fn start(&mut self) -> StartW<'_, TcmrSpec> {
    StartW::new(self, 8)
  }
  #[doc = "Bits 16:23 - Transmit Start Delay"]
  #[inline(always)]
  pub fn sttdly(&mut self) -> SttdlyW<'_, TcmrSpec> {
    SttdlyW::new(self, 16)
  }
  #[doc = "Bits 24:31 - Transmit Period Divider Selection"]
  #[inline(always)]
  pub fn period(&mut self) -> PeriodW<'_, TcmrSpec> {
    PeriodW::new(self, 24)
  }
}
