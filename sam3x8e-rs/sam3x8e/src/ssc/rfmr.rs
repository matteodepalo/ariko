...
impl W {
  #[doc = "Bits 0:4 - Data Length"]
  #[inline(always)]
  pub fn datlen(&mut self) -> DatlenW<'_, RfmrSpec> {
    DatlenW::new(self, 0)
  }
  #[doc = "Bit 5 - Loop Mode"]
  #[inline(always)]
  pub fn loop_(&mut self) -> LoopW<'_, RfmrSpec> {
    LoopW::new(self, 5)
  }
  #[doc = "Bit 7 - Most Significant Bit First"]
  #[inline(always)]
  pub fn msbf(&mut self) -> MsbfW<'_, RfmrSpec> {
    MsbfW::new(self, 7)
  }
  #[doc = "Bits 8:11 - Data Number per Frame"]
  #[inline(always)]
  pub fn datnb(&mut self) -> DatnbW<'_, RfmrSpec> {
    DatnbW::new(self, 8)
  }
  #[doc = "Bits 16:19 - Receive Frame Sync Length"]
  #[inline(always)]
  pub fn fslen(&mut self) -> FslenW<'_, RfmrSpec> {
    FslenW::new(self, 16)
  }
  #[doc = "Bits 20:22 - Receive Frame Sync Output Selection"]
  #[inline(always)]
  pub fn fsos(&mut self) -> FsosW<'_, RfmrSpec> {
    FsosW::new(self, 20)
  }
  #[doc = "Bit 24 - Frame Sync Edge Detection"]
  #[inline(always)]
  pub fn fsedge(&mut self) -> FsedgeW<'_, RfmrSpec> {
    FsedgeW::new(self, 24)
  }
  #[doc = "Bits 28:31 - FSLEN Field Extension"]
  #[inline(always)]
  pub fn fslen_ext(&mut self) -> FslenExtW<'_, RfmrSpec> {
