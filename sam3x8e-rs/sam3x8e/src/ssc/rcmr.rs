...
impl W {
  #[doc = "Bits 0:1 - Receive Clock Selection"]
  #[inline(always)]
  pub fn cks(&mut self) -> CksW<'_, RcmrSpec> {
    CksW::new(self, 0)
  }
  #[doc = "Bits 2:4 - Receive Clock Output Mode Selection"]
  #[inline(always)]
  pub fn cko(&mut self) -> CkoW<'_, RcmrSpec> {
    CkoW::new(self, 2)
  }
  #[doc = "Bit 5 - Receive Clock Inversion"]
  #[inline(always)]
  pub fn cki(&mut self) -> CkiW<'_, RcmrSpec> {
    CkiW::new(self, 5)
  }
  #[doc = "Bits 6:7 - Receive Clock Gating Selection"]
  #[inline(always)]
  pub fn ckg(&mut self) -> CkgW<'_, RcmrSpec> {
    CkgW::new(self, 6)
  }
  #[doc = "Bits 8:11 - Receive Start Selection"]
  #[inline(always)]
  pub fn start(&mut self) -> StartW<'_, RcmrSpec> {
    StartW::new(self, 8)
  }
  #[doc = "Bit 12 - Receive Stop Selection"]
  #[inline(always)]
  pub fn stop(&mut self) -> StopW<'_, RcmrSpec> {
    StopW::new(self, 12)
  }
  #[doc = "Bits 16:23 - Receive Start Delay"]
  #[inline(always)]
  pub fn sttdly(&mut self) -> SttdlyW<'_, RcmrSpec> {
    SttdlyW::new(self, 16)
  }
  #[doc = "Bits 24:31 - Receive Period Divider Selection"]
  #[inline(always)]
  pub fn period(&mut self) -> PeriodW<'_, RcmrSpec> {
    PeriodW::new(self, 24)
  }
}
