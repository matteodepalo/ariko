...
impl W {
  ...
  #[inline(always)]
  pub fn ovrun(&mut self) -> OvrunW<'_, IdrSpec> {
    OvrunW::new(self, 5)
  }
  #[doc = "Bit 8 - Compare 0 Interrupt Disable"]
  #[inline(always)]
  pub fn cp0(&mut self) -> Cp0W<'_, IdrSpec> {
    Cp0W::new(self, 8)
  }
  #[doc = "Bit 9 - Compare 1 Interrupt Disable"]
  #[inline(always)]
  pub fn cp1(&mut self) -> Cp1W<'_, IdrSpec> {
    Cp1W::new(self, 9)
  }
  #[doc = "Bit 10 - Tx Sync Interrupt Enable"]
  #[inline(always)]
  pub fn txsyn(&mut self) -> TxsynW<'_, IdrSpec> {
    TxsynW::new(self, 10)
  }
  #[doc = "Bit 11 - Rx Sync Interrupt Enable"]
  #[inline(always)]
  pub fn rxsyn(&mut self) -> RxsynW<'_, IdrSpec> {
    RxsynW::new(self, 11)
  }
}
