...
impl W {
  #[doc = "Bits 0:4 - Data Length"]
  #[inline(always)]
  pub fn datlen(&mut self) -> DatlenW<'_, TfmrSpec> {
    DatlenW::new(self, 0)
  }
  #[doc = "Bit 5 - Data Default Value"]
  #[inline(always)]
  pub fn datdef(&mut self) -> DatdefW<'_, TfmrSpec> {
    DatdefW::new(self, 5)
  }
  #[doc = "Bit 7 - Most Significant Bit First"]
  #[inline(always)]
  pub fn msbf(&mut self) -> MsbfW<'_, TfmrSpec> {
    MsbfW::new(self, 7)
  }
  #[doc = "Bits 8:11 - Data Number per frame"]
  #[inline(always)]
  pub fn datnb(&mut self) -> DatnbW<'_, TfmrSpec> {
    DatnbW::new(self, 8)
  }
  #[doc = "Bits 16:19 - Transmit Frame Sync Length"]
  #[inline(always)]
  pub fn fslen(&mut self) -> FslenW<'_, TfmrSpec> {
    FslenW::new(self, 16)
  }
  #[doc = "Bits 20:22 - Transmit Frame Sync Output Selection"]
  #[inline(always)]
  pub fn fsos(&mut self) -> FsosW<'_, TfmrSpec> {
    FsosW::new(self, 20)
  }
  #[doc = "Bit 23 - Frame Sync Data Enable"]
  #[inline(always)]
  pub fn fsden(&mut self) -> FsdenW<'_, TfmrSpec> {
    FsdenW::new(self, 23)
  }
  #[doc = "Bit 24 - Frame Sync Edge Detection"]
  #[inline(always)]
  pub fn fsedge(&mut self) -> FsedgeW<'_, TfmrSpec> {
    FsedgeW::new(self, 24)
  }
  #[doc = "Bits 28:31 - FSLEN Field Extension"]
  #[inline(always)]
  pub fn fslen_ext(&mut self) -> FslenExtW<'_, TfmrSpec> {
