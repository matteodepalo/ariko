...
impl W {
  #[doc = "Bits 0:7 - Maximum Number of Allowed Cycles for a Burst"]
  #[inline(always)]
  pub fn slot_cycle(&mut self) -> SlotCycleW<'_, MatrixScfgSpec> {
    SlotCycleW::new(self, 0)
  }
  #[doc = "Bits 16:17 - Default Master Type"]
  #[inline(always)]
  pub fn defmstr_type(&mut self) -> DefmstrTypeW<'_, MatrixScfgSpec> {
    DefmstrTypeW::new(self, 16)
  }
  #[doc = "Bits 18:20 - Fixed Default Master"]
  #[inline(always)]
  pub fn fixed_defmstr(&mut self) -> FixedDefmstrW<'_, MatrixScfgSpec> {
    FixedDefmstrW::new(self, 18)
  }
  #[doc = "Bits 24:25 - Arbitration Type"]
  #[inline(always)]
  pub fn arbt(&mut self) -> ArbtW<'_, MatrixScfgSpec> {
    ArbtW::new(self, 24)
  }
}
