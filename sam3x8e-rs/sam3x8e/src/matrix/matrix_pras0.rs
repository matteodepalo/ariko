...
impl W {
  #[doc = "Bits 0:1 - Master 0 Priority"]
  #[inline(always)]
  pub fn m0pr(&mut self) -> M0prW<'_, MatrixPras0Spec> {
    M0prW::new(self, 0)
  }
  #[doc = "Bits 4:5 - Master 1 Priority"]
  #[inline(always)]
  pub fn m1pr(&mut self) -> M1prW<'_, MatrixPras0Spec> {
    M1prW::new(self, 4)
  }
  #[doc = "Bits 8:9 - Master 2 Priority"]
  #[inline(always)]
  pub fn m2pr(&mut self) -> M2prW<'_, MatrixPras0Spec> {
    M2prW::new(self, 8)
  }
  #[doc = "Bits 12:13 - Master 3 Priority"]
  #[inline(always)]
  pub fn m3pr(&mut self) -> M3prW<'_, MatrixPras0Spec> {
    M3prW::new(self, 12)
  }
  #[doc = "Bits 16:17 - Master 4 Priority"]
  #[inline(always)]
  pub fn m4pr(&mut self) -> M4prW<'_, MatrixPras0Spec> {
    M4prW::new(self, 16)
  }
  #[doc = "Bits 20:21 - Master 5 Priority"]
  #[inline(always)]
  pub fn m5pr(&mut self) -> M5prW<'_, MatrixPras0Spec> {
    M5prW::new(self, 20)
  }
}
