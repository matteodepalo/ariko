...
impl W {
  ...
  #[inline(always)]
  pub fn rb_rise(&mut self) -> RbRiseW<'_, IerSpec> {
    RbRiseW::new(self, 4)
  }
  #[doc = "Bit 5 - Ready Busy Falling Edge Detection Interrupt Enable"]
  #[inline(always)]
  pub fn rb_fall(&mut self) -> RbFallW<'_, IerSpec> {
    RbFallW::new(self, 5)
  }
  ...
  #[inline(always)]
  pub fn cmddone(&mut self) -> CmddoneW<'_, IerSpec> {
  ...
  #[inline(always)]
  pub fn undef(&mut self) -> UndefW<'_, IerSpec> {
    UndefW::new(self, 21)
  }
  #[doc = "Bit 22 - Accessing While Busy Interrupt Enable"]
  #[inline(always)]
  pub fn awb(&mut self) -> AwbW<'_, IerSpec> {
    AwbW::new(self, 22)
  }
  #[doc = "Bit 23 - NFC Access Size Error Interrupt Enable"]
  #[inline(always)]
  pub fn nfcase(&mut self) -> NfcaseW<'_, IerSpec> {
    NfcaseW::new(self, 23)
  }
  #[doc = "Bit 24 - Ready/Busy Line 0 Interrupt Enable"]
  #[inline(always)]
  pub fn rb_edge0(&mut self) -> RbEdge0W<'_, IerSpec> {
