...
impl W {
  ...
  #[inline(always)]
  pub fn rb_rise(&mut self) -> RbRiseW<'_, IdrSpec> {
    RbRiseW::new(self, 4)
  }
  #[doc = "Bit 5 - Ready Busy Falling Edge Detection Interrupt Disable"]
  #[inline(always)]
  pub fn rb_fall(&mut self) -> RbFallW<'_, IdrSpec> {
    RbFallW::new(self, 5)
  }
  ...
  #[inline(always)]
  pub fn cmddone(&mut self) -> CmddoneW<'_, IdrSpec> {
  ...
  #[inline(always)]
  pub fn undef(&mut self) -> UndefW<'_, IdrSpec> {
    UndefW::new(self, 21)
  }
  #[doc = "Bit 22 - Accessing While Busy Interrupt Disable"]
  #[inline(always)]
  pub fn awb(&mut self) -> AwbW<'_, IdrSpec> {
    AwbW::new(self, 22)
  }
  #[doc = "Bit 23 - NFC Access Size Error Interrupt Disable"]
  #[inline(always)]
  pub fn nfcase(&mut self) -> NfcaseW<'_, IdrSpec> {
    NfcaseW::new(self, 23)
  }
  #[doc = "Bit 24 - Ready/Busy Line 0 Interrupt Disable"]
  #[inline(always)]
  pub fn rb_edge0(&mut self) -> RbEdge0W<'_, IdrSpec> {
