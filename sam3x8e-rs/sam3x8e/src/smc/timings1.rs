...
impl W {
  #[doc = "Bits 0:3 - CLE to REN Low Delay"]
  #[inline(always)]
  pub fn tclr(&mut self) -> TclrW<'_, Timings1Spec> {
    TclrW::new(self, 0)
  }
  #[doc = "Bits 4:7 - ALE to Data Start"]
  #[inline(always)]
  pub fn tadl(&mut self) -> TadlW<'_, Timings1Spec> {
    TadlW::new(self, 4)
  }
  #[doc = "Bits 8:11 - ALE to REN Low Delay"]
  #[inline(always)]
  pub fn tar(&mut self) -> TarW<'_, Timings1Spec> {
    TarW::new(self, 8)
  }
  #[doc = "Bit 12 - Off Chip Memory Scrambling Enable"]
  #[inline(always)]
  pub fn ocms(&mut self) -> OcmsW<'_, Timings1Spec> {
    OcmsW::new(self, 12)
  }
  #[doc = "Bits 16:19 - Ready to REN Low Delay"]
  #[inline(always)]
  pub fn trr(&mut self) -> TrrW<'_, Timings1Spec> {
    TrrW::new(self, 16)
  }
  #[doc = "Bits 24:27 - WEN High to REN to Busy"]
  #[inline(always)]
  pub fn twb(&mut self) -> TwbW<'_, Timings1Spec> {
    TwbW::new(self, 24)
  }
  #[doc = "Bits 28:30 - Ready/Busy Line Selection"]
  #[inline(always)]
  pub fn rbnsel(&mut self) -> RbnselW<'_, Timings1Spec> {
    RbnselW::new(self, 28)
  }
  #[doc = "Bit 31 - NAND Flash Selection"]
  #[inline(always)]
  pub fn nfsel(&mut self) -> NfselW<'_, Timings1Spec> {
    NfselW::new(self, 31)
  }
}
