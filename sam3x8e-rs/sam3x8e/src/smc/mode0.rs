...
impl W {
  #[doc = "Bit 0"]
  #[inline(always)]
  pub fn read_mode(&mut self) -> ReadModeW<'_, Mode0Spec> {
    ReadModeW::new(self, 0)
  }
  #[doc = "Bit 1"]
  #[inline(always)]
  pub fn write_mode(&mut self) -> WriteModeW<'_, Mode0Spec> {
    WriteModeW::new(self, 1)
  }
  #[doc = "Bits 4:5 - NWAIT Mode"]
  #[inline(always)]
  pub fn exnw_mode(&mut self) -> ExnwModeW<'_, Mode0Spec> {
    ExnwModeW::new(self, 4)
  }
  #[doc = "Bit 8 - Byte Access Type"]
  #[inline(always)]
  pub fn bat(&mut self) -> BatW<'_, Mode0Spec> {
    BatW::new(self, 8)
  }
  #[doc = "Bit 12 - Data Bus Width"]
  #[inline(always)]
  pub fn dbw(&mut self) -> DbwW<'_, Mode0Spec> {
    DbwW::new(self, 12)
  }
  #[doc = "Bits 16:19 - Data Float Time"]
  #[inline(always)]
  pub fn tdf_cycles(&mut self) -> TdfCyclesW<'_, Mode0Spec> {
    TdfCyclesW::new(self, 16)
  }
  #[doc = "Bit 20 - TDF Optimization"]
  #[inline(always)]
  pub fn tdf_mode(&mut self) -> TdfModeW<'_, Mode0Spec> {
