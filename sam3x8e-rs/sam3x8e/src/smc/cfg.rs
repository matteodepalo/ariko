...
impl W {
  #[doc = "Bits 0:1"]
  #[inline(always)]
  pub fn pagesize(&mut self) -> PagesizeW<'_, CfgSpec> {
    PagesizeW::new(self, 0)
  }
  #[doc = "Bit 8 - Write Spare Area"]
  #[inline(always)]
  pub fn wspare(&mut self) -> WspareW<'_, CfgSpec> {
    WspareW::new(self, 8)
  }
  #[doc = "Bit 9 - Read Spare Area"]
  #[inline(always)]
  pub fn rspare(&mut self) -> RspareW<'_, CfgSpec> {
    RspareW::new(self, 9)
  }
  #[doc = "Bit 12 - Rising/Falling Edge Detection Control"]
  #[inline(always)]
  pub fn edgectrl(&mut self) -> EdgectrlW<'_, CfgSpec> {
    EdgectrlW::new(self, 12)
  }
  #[doc = "Bit 13 - Ready/Busy Signal Edge Detection"]
  #[inline(always)]
  pub fn rbedge(&mut self) -> RbedgeW<'_, CfgSpec> {
    RbedgeW::new(self, 13)
  }
  #[doc = "Bits 16:19 - Data Timeout Cycle Number"]
  #[inline(always)]
  pub fn dtocyc(&mut self) -> DtocycW<'_, CfgSpec> {
    DtocycW::new(self, 16)
  }
  #[doc = "Bits 20:22 - Data Timeout Multiplier"]
  #[inline(always)]
  pub fn dtomul(&mut self) -> DtomulW<'_, CfgSpec> {
    DtomulW::new(self, 20)
  }
}
