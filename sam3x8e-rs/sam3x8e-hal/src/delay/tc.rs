...
macro_rules! timer_hal {
  ($timer_name:ident, $timer_source:ident, $reg_cmr:ident, $reg_rc:ident, $reg_ccr:ident, $reg_cv:ident) => {
    ...
    impl DelayNs for Delay<$timer_name> {
      ...
      fn delay_us(&mut self, us: u32) {
        ...
        // Password is "TIM" = 0x54494D
        unsafe {
          timer
            .wpmr()
            .write_with_zero(|w| w.wpen().clear_bit().wpkey().bits(0x54494D));
        }
        ...
        unsafe { timer.$reg_rc().write_with_zero(|w| w.bits(cycles)); }
...
timer_hal!(TimerCounter0, TC0, wave_eq_1_cmr0_wave_eq_1, rc0, ccr0, cv0);
timer_hal!(TimerCounter1, TC0, wave_eq_1_cmr1_wave_eq_1, rc1, ccr1, cv1);
timer_hal!(TimerCounter2, TC0, wave_eq_1_cmr2_wave_eq_1, rc2, ccr2, cv2);

timer_hal!(TimerCounter3, TC1, wave_eq_1_cmr0_wave_eq_1, rc0, ccr0, cv0);
timer_hal!(TimerCounter4, TC1, wave_eq_1_cmr1_wave_eq_1, rc1, ccr1, cv1);
timer_hal!(TimerCounter5, TC1, wave_eq_1_cmr2_wave_eq_1, rc2, ccr2, cv2);

timer_hal!(TimerCounter6, TC2, wave_eq_1_cmr0_wave_eq_1, rc0, ccr0, cv0);
timer_hal!(TimerCounter7, TC2, wave_eq_1_cmr1_wave_eq_1, rc1, ccr1, cv1);
timer_hal!(TimerCounter8, TC2, wave_eq_1_cmr2_wave_eq_1, rc2, ccr2, cv2);
